...
/**
 * HA1033_leftInfo_beforeArbitrate.hpp
 */

#ifndef HA1033_LEFTINFO_BEFOREARBITRATE_HPP
#define HA1033_LEFTINFO_BEFOREARBITRATE_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1033_leftInfo_beforeArbitrate.json"

namespace {

using namespace rba;

class HA1033_leftInfo_beforeArbitrate : public ::testing::Test
{
protected:
  HA1033_leftInfo_beforeArbitrate();
  virtual ~HA1033_leftInfo_beforeArbitrate();
  virtual void SetUp();
