...
/**
 * HA1209_MinOperator.hpp
 */

#ifndef HA1209_MINOPERATOR_HPP
#define HA1209_MINOPERATOR_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1209_MinOperator.json"

namespace {

using namespace rba;

class HA1209_MinOperator : public ::testing::Test
{
protected:
  HA1209_MinOperator();
  virtual ~HA1209_MinOperator();
  virtual void SetUp();
