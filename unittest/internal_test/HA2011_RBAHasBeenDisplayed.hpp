...
/**
 * HA2011_RBAHasBeenDisplayed.hpp
 */

#ifndef HA2011_RBAHASBEENDISPLAYED_HPP
#define HA2011_RBAHASBEENDISPLAYED_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA2011_RBAHasBeenDisplayed.json"

namespace {

using namespace rba;

class HA2011_RBAHasBeenDisplayed : public ::testing::Test
{
protected:
  HA2011_RBAHasBeenDisplayed();
  virtual ~HA2011_RBAHasBeenDisplayed();
  virtual void SetUp();
