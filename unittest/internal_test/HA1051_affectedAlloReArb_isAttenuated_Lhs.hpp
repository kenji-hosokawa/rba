...
/**
 * HA1051_affectedAlloReArb_isAttenuated_Lhs.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_ISATTENUATED_LHS_HPP
#define HA1051_AFFECTEDALLOREARB_ISATTENUATED_LHS_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_isAttenuated_Lhs.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_isAttenuated_Lhs : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_isAttenuated_Lhs();
  virtual ~HA1051_affectedAlloReArb_isAttenuated_Lhs();
  virtual void SetUp();
