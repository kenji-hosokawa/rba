...
/**
 * HA1051_affectedAlloReArb_isDisplayed_Rhs.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_ISDISPLAYED_RHS_HPP
#define HA1051_AFFECTEDALLOREARB_ISDISPLAYED_RHS_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_isDisplayed_Rhs.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_isDisplayed_Rhs : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_isDisplayed_Rhs();
  virtual ~HA1051_affectedAlloReArb_isDisplayed_Rhs();
  virtual void SetUp();
