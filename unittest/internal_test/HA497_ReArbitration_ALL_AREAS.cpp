...
/**
 * HA497_ReArbitration_ALL_AREAS.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HA497_ReArbitration_ALL_AREAS.hpp"
...
HA497_ReArbitration_ALL_AREAS::HA497_ReArbitration_ALL_AREAS(void)
{
}
...
void HA497_ReArbitration_ALL_AREAS::SetUp(void)
{
...
void HA497_ReArbitration_ALL_AREAS::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_ReArbitration_ALL_AREAS, Test_1) {
...
TEST_F(HA497_ReArbitration_ALL_AREAS, Test_ConfirmThatConstraintIsValid) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
