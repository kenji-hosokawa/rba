...
/**
 * HA497_AllocatedContent_LhsBeforeArbitrate.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HA497_AllocatedContent_LhsBeforeArbitrate.hpp"
...
HA497_AllocatedContent_LhsBeforeArbitrate::HA497_AllocatedContent_LhsBeforeArbitrate(void)
{
}
...
void HA497_AllocatedContent_LhsBeforeArbitrate::SetUp(void)
{
...
void HA497_AllocatedContent_LhsBeforeArbitrate::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_AllocatedContent_LhsBeforeArbitrate, Test_1) {
...
TEST_F(HA497_AllocatedContent_LhsBeforeArbitrate, Test_ConfirmThatConstraintIsValid) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
