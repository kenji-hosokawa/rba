...
/**
 * HA1051_affectedAlloReArb_isHidden_Rhs.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_ISHIDDEN_RHS_HPP
#define HA1051_AFFECTEDALLOREARB_ISHIDDEN_RHS_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_isHidden_Rhs.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_isHidden_Rhs : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_isHidden_Rhs();
  virtual ~HA1051_affectedAlloReArb_isHidden_Rhs();
  virtual void SetUp();
