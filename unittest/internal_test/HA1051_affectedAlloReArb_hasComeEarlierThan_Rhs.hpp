...
/**
 * HA1051_affectedAlloReArb_hasComeEarlierThan_Rhs.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_HASCOMEEARLIERTHAN_RHS_HPP
#define HA1051_AFFECTEDALLOREARB_HASCOMEEARLIERTHAN_RHS_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_hasComeEarlierThan_Rhs.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_hasComeEarlierThan_Rhs : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_hasComeEarlierThan_Rhs();
  virtual ~HA1051_affectedAlloReArb_hasComeEarlierThan_Rhs();
  virtual void SetUp();
