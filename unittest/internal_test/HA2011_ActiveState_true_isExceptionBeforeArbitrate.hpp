...
/**
 * HA2011_ActiveState_true_isExceptionBeforeArbitrate.hpp
 */

#ifndef HA2011_ACTIVESTATE_TRUE_ISEXCEPTIONBEFOREARBITRATE_HPP
#define HA2011_ACTIVESTATE_TRUE_ISEXCEPTIONBEFOREARBITRATE_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA2011_ActiveState_true_isExceptionBeforeArbitrate.json"

namespace {

using namespace rba;

class HA2011_ActiveState_true_isExceptionBeforeArbitrate : public ::testing::Test
{
protected:
  HA2011_ActiveState_true_isExceptionBeforeArbitrate();
  virtual ~HA2011_ActiveState_true_isExceptionBeforeArbitrate();
  virtual void SetUp();
