...
/**
 * HA1209_ActiveState.hpp
 */

#ifndef HA1209_ACTIVESTATE_HPP
#define HA1209_ACTIVESTATE_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1209_ActiveState.json"

namespace {

using namespace rba;

class HA1209_ActiveState : public ::testing::Test
{
protected:
  HA1209_ActiveState();
  virtual ~HA1209_ActiveState();
  virtual void SetUp();
