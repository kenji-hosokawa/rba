...
/**
 * HA1033_ExceptionBeforeArbitrate.hpp
 */

#ifndef HA1033_EXCEPTIONBEFOREARBITRATE_HPP
#define HA1033_EXCEPTIONBEFOREARBITRATE_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1033_ExceptionBeforeArbitrate.json"

namespace {

using namespace rba;

class HA1033_ExceptionBeforeArbitrate : public ::testing::Test
{
protected:
  HA1033_ExceptionBeforeArbitrate();
  virtual ~HA1033_ExceptionBeforeArbitrate();
  virtual void SetUp();
