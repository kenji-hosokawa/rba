...
/**
 * HA497_JsonParser_2byteChar.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HA497_JsonParser_2byteChar.hpp"
...
HA497_JsonParser_2byteChar::HA497_JsonParser_2byteChar(void)
{
}
...
void HA497_JsonParser_2byteChar::SetUp(void)
{
...
void HA497_JsonParser_2byteChar::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_JsonParser_2byteChar, Test_1) {
  ...
  elems = {u8"Assert",u8"A",u8"Ā",u8"A1"};
  {
    std::string kind = elems[1];
  ...
  elems = {u8"Assert",u8"A",u8"ก",u8"B1"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"ｽ",u8"C1"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
