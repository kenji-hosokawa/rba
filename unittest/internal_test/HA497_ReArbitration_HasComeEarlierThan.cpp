...
/**
 * HA497_ReArbitration_HasComeEarlierThan.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HA497_ReArbitration_HasComeEarlierThan.hpp"
...
HA497_ReArbitration_HasComeEarlierThan::HA497_ReArbitration_HasComeEarlierThan(void)
{
}
...
void HA497_ReArbitration_HasComeEarlierThan::SetUp(void)
{
...
void HA497_ReArbitration_HasComeEarlierThan::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_ReArbitration_HasComeEarlierThan, Test_1) {
...
TEST_F(HA497_ReArbitration_HasComeEarlierThan, Test_ConfirmThatConstraintIsValid) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
