...
/**
 * HA1210_IsTypeOfOperator.hpp
 */

#ifndef HA1210_ISTYPEOFOPERATOR_HPP
#define HA1210_ISTYPEOFOPERATOR_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1210_IsTypeOfOperator.json"

namespace {

using namespace rba;

class HA1210_IsTypeOfOperator : public ::testing::Test
{
protected:
  HA1210_IsTypeOfOperator();
  virtual ~HA1210_IsTypeOfOperator();
  virtual void SetUp();
