...
#include "HA497_execute_list.hpp"
...
HA497_execute_list::HA497_execute_list(void)
{
}
...
void HA497_execute_list::SetUp(void)
{
...
void HA497_execute_list::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_execute_list, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;

  std::list<std::string> cont = {"A1/NORMAL","C1/NORMAL"};
  result = arb->execute(cont, true);
