...
/**
 * HA497_HasComeLaterThan_Pre.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HA497_HasComeLaterThan_Pre.hpp"
...
HA497_HasComeLaterThan_Pre::HA497_HasComeLaterThan_Pre(void)
{
}
...
void HA497_HasComeLaterThan_Pre::SetUp(void)
{
...
void HA497_HasComeLaterThan_Pre::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_HasComeLaterThan_Pre, Test_1) {
...
TEST_F(HA497_HasComeLaterThan_Pre, Test_ConfirmThatConstraintIsValid) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
