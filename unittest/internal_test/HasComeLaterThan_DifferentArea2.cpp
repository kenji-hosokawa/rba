...
/**
 * HasComeLaterThan_DifferentArea2.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HasComeLaterThan_DifferentArea2.hpp"
...
HasComeLaterThan_DifferentArea2::HasComeLaterThan_DifferentArea2(void)
{
}
...
void HasComeLaterThan_DifferentArea2::SetUp(void)
{
...
void HasComeLaterThan_DifferentArea2::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HasComeLaterThan_DifferentArea2, Test_TwoRequests1) {
...
TEST_F(HasComeLaterThan_DifferentArea2, Test_TwoRequests2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeLaterThan_DifferentArea2, Test_OneRequest2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeLaterThan_DifferentArea2, Test_OneRequest1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
