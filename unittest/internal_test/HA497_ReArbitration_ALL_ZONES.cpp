...
/**
 * HA497_ReArbitration_ALL_ZONES.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HA497_ReArbitration_ALL_ZONES.hpp"
...
HA497_ReArbitration_ALL_ZONES::HA497_ReArbitration_ALL_ZONES(void)
{
}
...
void HA497_ReArbitration_ALL_ZONES::SetUp(void)
{
...
void HA497_ReArbitration_ALL_ZONES::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_ReArbitration_ALL_ZONES, Test_1) {
...
TEST_F(HA497_ReArbitration_ALL_ZONES, Test_ConfirmThatConstraintIsValid) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
