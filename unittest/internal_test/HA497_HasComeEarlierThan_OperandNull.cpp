...
/**
 * HA497_HasComeEarlierThan_OperandNull.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HA497_HasComeEarlierThan_OperandNull.hpp"
...
HA497_HasComeEarlierThan_OperandNull::HA497_HasComeEarlierThan_OperandNull(void)
{
}
...
void HA497_HasComeEarlierThan_OperandNull::SetUp(void)
{
...
void HA497_HasComeEarlierThan_OperandNull::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_HasComeEarlierThan_OperandNull, Test_ConfirmThatConstraintIsValid_true) {
...
TEST_F(HA497_HasComeEarlierThan_OperandNull, Test_RhsIsNull) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HA497_HasComeEarlierThan_OperandNull, Test_LhsIsNull) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HA497_HasComeEarlierThan_OperandNull, Test_ConfirmThatConstraintIsValid_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
