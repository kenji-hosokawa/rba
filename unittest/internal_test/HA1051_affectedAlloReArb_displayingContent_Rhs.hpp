...
/**
 * HA1051_affectedAlloReArb_displayingContent_Rhs.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_DISPLAYINGCONTENT_RHS_HPP
#define HA1051_AFFECTEDALLOREARB_DISPLAYINGCONTENT_RHS_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_displayingContent_Rhs.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_displayingContent_Rhs : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_displayingContent_Rhs();
  virtual ~HA1051_affectedAlloReArb_displayingContent_Rhs();
  virtual void SetUp();
