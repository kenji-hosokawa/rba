...
/**
 * HA1871_matrix_log.hpp
 */

#ifndef HA1871_MATRIX_LOG_HPP
#define HA1871_MATRIX_LOG_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1871_matrix_log.json"

namespace {

using namespace rba;

class HA1871_matrix_log : public ::testing::Test
{
protected:
  HA1871_matrix_log();
  virtual ~HA1871_matrix_log();
  virtual void SetUp();
