...
HA578_If_Hidden::HA578_If_Hidden(void)
{
}
...
void HA578_If_Hidden::SetUp(void)
{
...
void HA578_If_Hidden::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA578_If_Hidden, Test_1) {
  ...
  elems = {"Assert",u8"A",u8"エリアA",u8"a1"};
  {
    std::string kind = elems[1];
  ...
  elems = {"Assert",u8"A",u8"エリアB",u8"NULL"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
...
TEST_F(HA578_If_Hidden, Test_4) {
  ...
  elems = {"Assert",u8"A",u8"エリアA",u8"NULL"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
  ...
  elems = {"Assert",u8"A",u8"エリアB",u8"b1"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
