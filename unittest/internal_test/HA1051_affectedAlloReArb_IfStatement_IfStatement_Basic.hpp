...
/**
 * HA1051_affectedAlloReArb_IfStatement_IfStatement_Basic.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_IFSTATEMENT_IFSTATEMENT_BASIC_HPP
#define HA1051_AFFECTEDALLOREARB_IFSTATEMENT_IFSTATEMENT_BASIC_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_IfStatement_IfStatement_Basic.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_IfStatement_IfStatement_Basic : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_IfStatement_IfStatement_Basic();
  virtual ~HA1051_affectedAlloReArb_IfStatement_IfStatement_Basic();
  virtual void SetUp();
