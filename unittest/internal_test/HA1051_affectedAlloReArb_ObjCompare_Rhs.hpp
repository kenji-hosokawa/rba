...
/**
 * HA1051_affectedAlloReArb_ObjCompare_Rhs.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_OBJCOMPARE_RHS_HPP
#define HA1051_AFFECTEDALLOREARB_OBJCOMPARE_RHS_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_ObjCompare_Rhs.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_ObjCompare_Rhs : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_ObjCompare_Rhs();
  virtual ~HA1051_affectedAlloReArb_ObjCompare_Rhs();
  virtual void SetUp();
