...
/**
 * HA1051_affectedAlloReArb_allocatables_Rhs.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_ALLOCATABLES_RHS_HPP
#define HA1051_AFFECTEDALLOREARB_ALLOCATABLES_RHS_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_allocatables_Rhs.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_allocatables_Rhs : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_allocatables_Rhs();
  virtual ~HA1051_affectedAlloReArb_allocatables_Rhs();
  virtual void SetUp();
