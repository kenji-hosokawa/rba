...
/**
 * HA1211_ContentAllocatableCollector.hpp
 */

#ifndef HA1211_CONTENTALLOCATABLECOLLECTOR_HPP
#define HA1211_CONTENTALLOCATABLECOLLECTOR_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1211_ContentAllocatableCollector.json"

namespace {

using namespace rba;

class HA1211_ContentAllocatableCollector : public ::testing::Test
{
protected:
  HA1211_ContentAllocatableCollector();
  virtual ~HA1211_ContentAllocatableCollector();
  virtual void SetUp();
