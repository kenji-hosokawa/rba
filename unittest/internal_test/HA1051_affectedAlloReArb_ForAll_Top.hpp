...
/**
 * HA1051_affectedAlloReArb_ForAll_Top.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_FORALL_TOP_HPP
#define HA1051_AFFECTEDALLOREARB_FORALL_TOP_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_ForAll_Top.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_ForAll_Top : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_ForAll_Top();
  virtual ~HA1051_affectedAlloReArb_ForAll_Top();
  virtual void SetUp();
