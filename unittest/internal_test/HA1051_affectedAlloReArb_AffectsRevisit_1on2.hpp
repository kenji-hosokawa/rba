...
/**
 * HA1051_affectedAlloReArb_AffectsRevisit_1on2.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_AFFECTSREVISIT_1ON2_HPP
#define HA1051_AFFECTEDALLOREARB_AFFECTSREVISIT_1ON2_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_AffectsRevisit_1on2.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_AffectsRevisit_1on2 : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_AffectsRevisit_1on2();
  virtual ~HA1051_affectedAlloReArb_AffectsRevisit_1on2();
  virtual void SetUp();
