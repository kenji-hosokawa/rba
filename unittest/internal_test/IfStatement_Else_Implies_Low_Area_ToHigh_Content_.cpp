...
/**
 * IfStatement_Else_Implies_Low_Area_ToHigh_Content_.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "IfStatement_Else_Implies_Low_Area_ToHigh_Content_.hpp"
...
IfStatement_Else_Implies_Low_Area_ToHigh_Content_::IfStatement_Else_Implies_Low_Area_ToHigh_Content_(void)
{
}
...
void IfStatement_Else_Implies_Low_Area_ToHigh_Content_::SetUp(void)
{
...
void IfStatement_Else_Implies_Low_Area_ToHigh_Content_::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(IfStatement_Else_Implies_Low_Area_ToHigh_Content_, Test_1) {
...
TEST_F(IfStatement_Else_Implies_Low_Area_ToHigh_Content_, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_Else_Implies_Low_Area_ToHigh_Content_, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
