...
/**
 * HA1051_affectedAlloReArb_isActive_Lhs.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_ISACTIVE_LHS_HPP
#define HA1051_AFFECTEDALLOREARB_ISACTIVE_LHS_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_isActive_Lhs.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_isActive_Lhs : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_isActive_Lhs();
  virtual ~HA1051_affectedAlloReArb_isActive_Lhs();
  virtual void SetUp();
