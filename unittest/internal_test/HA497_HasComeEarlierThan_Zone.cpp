...
/**
 * HA497_HasComeEarlierThan_Zone.cpp
 */

#include "HA497_HasComeEarlierThan_Zone.hpp"
...
HA497_HasComeEarlierThan_Zone::HA497_HasComeEarlierThan_Zone(void)
{
}
...
void HA497_HasComeEarlierThan_Zone::SetUp(void)
{
...
void HA497_HasComeEarlierThan_Zone::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_HasComeEarlierThan_Zone, Test_1) {
...
TEST_F(HA497_HasComeEarlierThan_Zone, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
