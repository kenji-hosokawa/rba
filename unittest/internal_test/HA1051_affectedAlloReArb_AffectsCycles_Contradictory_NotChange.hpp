...
/**
 * HA1051_affectedAlloReArb_AffectsCycles_Contradictory_NotChange.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_AFFECTSCYCLES_CONTRADICTORY_NOTCHANGE_HPP
#define HA1051_AFFECTEDALLOREARB_AFFECTSCYCLES_CONTRADICTORY_NOTCHANGE_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_AffectsCycles_Contradictory_NotChange.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_AffectsCycles_Contradictory_NotChange : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_AffectsCycles_Contradictory_NotChange();
  virtual ~HA1051_affectedAlloReArb_AffectsCycles_Contradictory_NotChange();
  virtual void SetUp();
