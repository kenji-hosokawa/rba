...
/**
 * HA1207_HasBeenDisplayed_Pre.hpp
 */

#ifndef HA1207_HASBEENDISPLAYED_PRE_HPP
#define HA1207_HASBEENDISPLAYED_PRE_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1207_HasBeenDisplayed_Pre.json"

namespace {

using namespace rba;

class HA1207_HasBeenDisplayed_Pre : public ::testing::Test
{
protected:
  HA1207_HasBeenDisplayed_Pre();
  virtual ~HA1207_HasBeenDisplayed_Pre();
  virtual void SetUp();
