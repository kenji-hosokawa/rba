...
#include "HA497_DisplayingContentImpl.hpp"
...
HA497_DisplayingContentImpl::HA497_DisplayingContentImpl(void)
{
}
...
void HA497_DisplayingContentImpl::SetUp(void)
{
...
void HA497_DisplayingContentImpl::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_DisplayingContentImpl, Test_1) {
...
TEST_F(HA497_DisplayingContentImpl, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
