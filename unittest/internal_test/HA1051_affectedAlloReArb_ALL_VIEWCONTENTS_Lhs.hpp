...
/**
 * HA1051_affectedAlloReArb_ALL_VIEWCONTENTS_Lhs.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_ALL_VIEWCONTENTS_LHS_HPP
#define HA1051_AFFECTEDALLOREARB_ALL_VIEWCONTENTS_LHS_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_ALL_VIEWCONTENTS_Lhs.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_ALL_VIEWCONTENTS_Lhs : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_ALL_VIEWCONTENTS_Lhs();
  virtual ~HA1051_affectedAlloReArb_ALL_VIEWCONTENTS_Lhs();
  virtual void SetUp();
