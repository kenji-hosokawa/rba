...
/**
 * IfStatement_Else_Implies_High_Content_ToLow_Area_.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "IfStatement_Else_Implies_High_Content_ToLow_Area_.hpp"
...
IfStatement_Else_Implies_High_Content_ToLow_Area_::IfStatement_Else_Implies_High_Content_ToLow_Area_(void)
{
}
...
void IfStatement_Else_Implies_High_Content_ToLow_Area_::SetUp(void)
{
...
void IfStatement_Else_Implies_High_Content_ToLow_Area_::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(IfStatement_Else_Implies_High_Content_ToLow_Area_, Test_1) {
...
TEST_F(IfStatement_Else_Implies_High_Content_ToLow_Area_, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_Else_Implies_High_Content_ToLow_Area_, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
