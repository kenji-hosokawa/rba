...
/**
 * HA1208_LetStatement.hpp
 */

#ifndef HA1208_LETSTATEMENT_HPP
#define HA1208_LETSTATEMENT_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1208_LetStatement.json"

namespace {

using namespace rba;

class HA1208_LetStatement : public ::testing::Test
{
protected:
  HA1208_LetStatement();
  virtual ~HA1208_LetStatement();
  virtual void SetUp();
