...
/**
 * HA1051_affectedAlloReArb_LowerThan_Rhs.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_LOWERTHAN_RHS_HPP
#define HA1051_AFFECTEDALLOREARB_LOWERTHAN_RHS_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_LowerThan_Rhs.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_LowerThan_Rhs : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_LowerThan_Rhs();
  virtual ~HA1051_affectedAlloReArb_LowerThan_Rhs();
  virtual void SetUp();
