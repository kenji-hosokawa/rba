...
/**
 * HA497_HasComeLaterThan_OperandNull.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HA497_HasComeLaterThan_OperandNull.hpp"
...
HA497_HasComeLaterThan_OperandNull::HA497_HasComeLaterThan_OperandNull(void)
{
}
...
void HA497_HasComeLaterThan_OperandNull::SetUp(void)
{
...
void HA497_HasComeLaterThan_OperandNull::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_HasComeLaterThan_OperandNull, Test_ConfirmThatConstraintIsValid_true) {
...
TEST_F(HA497_HasComeLaterThan_OperandNull, Test_RhsIsNull) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HA497_HasComeLaterThan_OperandNull, Test_LhsIsNull) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HA497_HasComeLaterThan_OperandNull, Test_ConfirmThatConstraintIsValid_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
