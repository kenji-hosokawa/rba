...
/**
 * HA1051_affectedAlloReArb_AffectsAffects_EachOther.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_AFFECTSAFFECTS_EACHOTHER_HPP
#define HA1051_AFFECTEDALLOREARB_AFFECTSAFFECTS_EACHOTHER_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_AffectsAffects_EachOther.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_AffectsAffects_EachOther : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_AffectsAffects_EachOther();
  virtual ~HA1051_affectedAlloReArb_AffectsAffects_EachOther();
  virtual void SetUp();
