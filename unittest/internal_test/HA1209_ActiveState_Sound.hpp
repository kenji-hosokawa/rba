...
/**
 * HA1209_ActiveState_Sound.hpp
 */

#ifndef HA1209_ACTIVESTATE_SOUND_HPP
#define HA1209_ACTIVESTATE_SOUND_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1209_ActiveState_Sound.json"

namespace {

using namespace rba;

class HA1209_ActiveState_Sound : public ::testing::Test
{
protected:
  HA1209_ActiveState_Sound()=default;
  virtual ~HA1209_ActiveState_Sound()=default;
  virtual void SetUp();
