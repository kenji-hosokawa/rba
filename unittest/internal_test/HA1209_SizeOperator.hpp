...
/**
 * HA1209_SizeOperator.hpp
 */

#ifndef HA1209_SIZEOPERATOR_HPP
#define HA1209_SIZEOPERATOR_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1209_SizeOperator.json"

namespace {

using namespace rba;

class HA1209_SizeOperator : public ::testing::Test
{
protected:
  HA1209_SizeOperator();
  virtual ~HA1209_SizeOperator();
  virtual void SetUp();
