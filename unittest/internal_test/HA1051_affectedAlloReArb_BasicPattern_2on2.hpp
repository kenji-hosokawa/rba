...
/**
 * HA1051_affectedAlloReArb_BasicPattern_2on2.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_BASICPATTERN_2ON2_HPP
#define HA1051_AFFECTEDALLOREARB_BASICPATTERN_2ON2_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_BasicPattern_2on2.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_BasicPattern_2on2 : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_BasicPattern_2on2();
  virtual ~HA1051_affectedAlloReArb_BasicPattern_2on2();
  virtual void SetUp();
