...
/**
 * HA1051_affectedAlloReArb_GreaterThan_Rhs.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_GREATERTHAN_RHS_HPP
#define HA1051_AFFECTEDALLOREARB_GREATERTHAN_RHS_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_GreaterThan_Rhs.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_GreaterThan_Rhs : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_GreaterThan_Rhs();
  virtual ~HA1051_affectedAlloReArb_GreaterThan_Rhs();
  virtual void SetUp();
