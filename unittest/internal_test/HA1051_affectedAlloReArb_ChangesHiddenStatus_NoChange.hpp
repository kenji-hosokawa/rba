...
/**
 * HA1051_affectedAlloReArb_ChangesHiddenStatus_NoChange.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_CHANGESHIDDENSTATUS_NOCHANGE_HPP
#define HA1051_AFFECTEDALLOREARB_CHANGESHIDDENSTATUS_NOCHANGE_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_ChangesHiddenStatus_NoChange.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_ChangesHiddenStatus_NoChange : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_ChangesHiddenStatus_NoChange();
  virtual ~HA1051_affectedAlloReArb_ChangesHiddenStatus_NoChange();
  virtual void SetUp();
