...
/**
 * HA2065_coverageLog.hpp
 */

#ifndef HA2065_COVERAGELOG_HPP
#define HA2065_COVERAGELOG_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA2065_coverageLog.json"

namespace {

using namespace rba;

class HA2065_coverageLog : public ::testing::Test
{
protected:
  HA2065_coverageLog();
  virtual ~HA2065_coverageLog();
  virtual void SetUp();
