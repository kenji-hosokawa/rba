...
/**
 * HA1051_affectedAlloReArb_IfStatement_Top.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_IFSTATEMENT_TOP_HPP
#define HA1051_AFFECTEDALLOREARB_IFSTATEMENT_TOP_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_IfStatement_Top.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_IfStatement_Top : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_IfStatement_Top();
  virtual ~HA1051_affectedAlloReArb_IfStatement_Top();
  virtual void SetUp();
