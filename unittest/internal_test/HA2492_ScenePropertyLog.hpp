...
/**
 * HA2492_ScenePropertyLog.hpp
 */

#ifndef HA2492_SCENEPROPERTYLOG_HPP
#define HA2492_SCENEPROPERTYLOG_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA2492_ScenePropertyLog.json"

namespace {

using namespace rba;

class HA2492_ScenePropertyLog : public ::testing::Test
{
protected:
  HA2492_ScenePropertyLog();
  virtual ~HA2492_ScenePropertyLog();
  virtual void SetUp();
