...
/**
 * HA1051_affectedAlloReArb_outputtingSound_Rhs.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_OUTPUTTINGSOUND_RHS_HPP
#define HA1051_AFFECTEDALLOREARB_OUTPUTTINGSOUND_RHS_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_outputtingSound_Rhs.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_outputtingSound_Rhs : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_outputtingSound_Rhs();
  virtual ~HA1051_affectedAlloReArb_outputtingSound_Rhs();
  virtual void SetUp();
