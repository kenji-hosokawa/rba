...
/**
 * HA1051_affectedAlloReArb_AffectsRevisit_1on1.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_AFFECTSREVISIT_1ON1_HPP
#define HA1051_AFFECTEDALLOREARB_AFFECTSREVISIT_1ON1_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_AffectsRevisit_1on1.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_AffectsRevisit_1on1 : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_AffectsRevisit_1on1();
  virtual ~HA1051_affectedAlloReArb_AffectsRevisit_1on1();
  virtual void SetUp();
