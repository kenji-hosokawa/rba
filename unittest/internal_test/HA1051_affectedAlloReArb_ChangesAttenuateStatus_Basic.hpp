...
/**
 * HA1051_affectedAlloReArb_ChangesAttenuateStatus_Basic.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_CHANGESATTENUATESTATUS_BASIC_HPP
#define HA1051_AFFECTEDALLOREARB_CHANGESATTENUATESTATUS_BASIC_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_ChangesAttenuateStatus_Basic.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_ChangesAttenuateStatus_Basic : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_ChangesAttenuateStatus_Basic();
  virtual ~HA1051_affectedAlloReArb_ChangesAttenuateStatus_Basic();
  virtual void SetUp();
