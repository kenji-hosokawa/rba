...
/**
 * HA1051_affectedAlloReArb_AffectsCycles_Contradictory_KeepChanging.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_AFFECTSCYCLES_CONTRADICTORY_KEEPCHANGING_HPP
#define HA1051_AFFECTEDALLOREARB_AFFECTSCYCLES_CONTRADICTORY_KEEPCHANGING_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_AffectsCycles_Contradictory_KeepChanging.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_AffectsCycles_Contradictory_KeepChanging : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_AffectsCycles_Contradictory_KeepChanging();
  virtual ~HA1051_affectedAlloReArb_AffectsCycles_Contradictory_KeepChanging();
  virtual void SetUp();
