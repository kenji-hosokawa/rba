...
/**
 * HA497_JsonParser_Sound.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HA497_JsonParser_Sound.hpp"
...
HA497_JsonParser_Sound::HA497_JsonParser_Sound(void)
{
}
...
void HA497_JsonParser_Sound::SetUp(void)
{
...
void HA497_JsonParser_Sound::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_JsonParser_Sound, Test_1) {
  ...
  elems = {u8"Assert",u8"A",u8"ASound",u8"A1"};
  {
    std::string kind = elems[1];
  ...
  elems = {u8"Assert",u8"A",u8"CSound",u8"NULL"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
...
TEST_F(HA497_JsonParser_Sound, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
  ...
  elems = {u8"Assert",u8"A",u8"ASound",u8"NULL"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"CSound",u8"C1"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
...
TEST_F(HA497_JsonParser_Sound, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
  ...
  elems = {u8"Assert",u8"A",u8"A",u8"B1"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
