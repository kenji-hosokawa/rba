...
/**
 * HA1051_affectedAlloReArb_IfStatement_Implies_Basic.hpp
 */

#ifndef HA1051_AFFECTEDALLOREARB_IFSTATEMENT_IMPLIES_BASIC_HPP
#define HA1051_AFFECTEDALLOREARB_IFSTATEMENT_IMPLIES_BASIC_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1051_affectedAlloReArb_IfStatement_Implies_Basic.json"

namespace {

using namespace rba;

class HA1051_affectedAlloReArb_IfStatement_Implies_Basic : public ::testing::Test
{
protected:
  HA1051_affectedAlloReArb_IfStatement_Implies_Basic();
  virtual ~HA1051_affectedAlloReArb_IfStatement_Implies_Basic();
  virtual void SetUp();
