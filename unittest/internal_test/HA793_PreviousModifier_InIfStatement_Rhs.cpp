/**
 * HA793_PreviousModifier_InIfStatement_Rhs.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HA793_PreviousModifier_InIfStatement_Rhs.hpp"
...
HA793_PreviousModifier_InIfStatement_Rhs::HA793_PreviousModifier_InIfStatement_Rhs(void)
{
}
...
void HA793_PreviousModifier_InIfStatement_Rhs::SetUp(void)
{
...
void HA793_PreviousModifier_InIfStatement_Rhs::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA793_PreviousModifier_InIfStatement_Rhs, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;

  elems = {"S",u8"ON",u8"シーン"};
  {
...
TEST_F(HA793_PreviousModifier_InIfStatement_Rhs, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HA793_PreviousModifier_InIfStatement_Rhs, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HA793_PreviousModifier_InIfStatement_Rhs, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
