...
/**
 * HA497_ReArbitration_ContentsList.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HA497_ReArbitration_ContentsList.hpp"
...
HA497_ReArbitration_ContentsList::HA497_ReArbitration_ContentsList(void)
{
}
...
void HA497_ReArbitration_ContentsList::SetUp(void)
{
...
void HA497_ReArbitration_ContentsList::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_ReArbitration_ContentsList, Test_1) {
...
TEST_F(HA497_ReArbitration_ContentsList, Test_ConfirmThatConstraintIsValid) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
