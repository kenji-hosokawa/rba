...
/**
 * HA1209_MaxOperator.hpp
 */

#ifndef HA1209_MAXOPERATOR_HPP
#define HA1209_MAXOPERATOR_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1209_MaxOperator.json"

namespace {

using namespace rba;

class HA1209_MaxOperator : public ::testing::Test
{
protected:
  HA1209_MaxOperator();
  virtual ~HA1209_MaxOperator();
  virtual void SetUp();
