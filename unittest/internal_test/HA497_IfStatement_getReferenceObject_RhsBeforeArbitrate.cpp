...
/**
 * HA497_IfStatement_getReferenceObject_RhsBeforeArbitrate.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HA497_IfStatement_getReferenceObject_RhsBeforeArbitrate.hpp"
...
HA497_IfStatement_getReferenceObject_RhsBeforeArbitrate::HA497_IfStatement_getReferenceObject_RhsBeforeArbitrate(void)
{
}
...
void HA497_IfStatement_getReferenceObject_RhsBeforeArbitrate::SetUp(void)
{
...
void HA497_IfStatement_getReferenceObject_RhsBeforeArbitrate::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_IfStatement_getReferenceObject_RhsBeforeArbitrate, Test_1) {
...
TEST_F(HA497_IfStatement_getReferenceObject_RhsBeforeArbitrate, Test_ConfirmThatConstraintIsValid) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
