...
/**
 * HA492_AreaWithNoContents.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HA492_AreaWithNoContents.hpp"
...
HA492_AreaWithNoContents::HA492_AreaWithNoContents(void)
{
}
...
void HA492_AreaWithNoContents::SetUp(void)
{
...
void HA492_AreaWithNoContents::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA492_AreaWithNoContents, Test_1) {
