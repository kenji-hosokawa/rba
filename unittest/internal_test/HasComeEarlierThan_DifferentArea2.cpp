...
/**
 * HasComeEarlierThan_DifferentArea2.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HasComeEarlierThan_DifferentArea2.hpp"
...
HasComeEarlierThan_DifferentArea2::HasComeEarlierThan_DifferentArea2(void)
{
}
...
void HasComeEarlierThan_DifferentArea2::SetUp(void)
{
...
void HasComeEarlierThan_DifferentArea2::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HasComeEarlierThan_DifferentArea2, Test_TwoRequests1) {
...
TEST_F(HasComeEarlierThan_DifferentArea2, Test_TwoRequests2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeEarlierThan_DifferentArea2, Test_OneRequest2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeEarlierThan_DifferentArea2, Test_OneRequest1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
