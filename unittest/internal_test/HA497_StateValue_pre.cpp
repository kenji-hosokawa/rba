...
/**
 * HA497_StateValue_pre.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HA497_StateValue_pre.hpp"
...
HA497_StateValue_pre::HA497_StateValue_pre(void)
{
}
...
void HA497_StateValue_pre::SetUp(void)
{
...
void HA497_StateValue_pre::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA497_StateValue_pre, Test_1) {
...
TEST_F(HA497_StateValue_pre, Test_ConfirmThatConstraintIsValid) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
