...
#include "HA760_ReArbitrateByIsHidden.hpp"
...
HA760_ReArbitrateByIsHidden::HA760_ReArbitrateByIsHidden(void)
{
}
...
void HA760_ReArbitrateByIsHidden::SetUp(void)
{
...
void HA760_ReArbitrateByIsHidden::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HA760_ReArbitrateByIsHidden, Test_1) {
