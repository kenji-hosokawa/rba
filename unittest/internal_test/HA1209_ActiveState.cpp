...
#include "HA1209_ActiveState.hpp"
...
HA1209_ActiveState::HA1209_ActiveState() {}
HA1209_ActiveState::~HA1209_ActiveState() {}

void HA1209_ActiveState::SetUp()
{
#ifdef RBA_USE_LOG
  std::unique_ptr<stub::StubLogCollector>
  collector = std::make_unique<stub::StubLogCollector>(JSONPATH"/HA1209_ActiveState.log",
                                                        LOGPATH"/HA1209_ActiveState.log",
                                                        true);
  // カバレッジログの設定
...
void HA1209_ActiveState::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA1209_ActiveState::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA1209_ActiveState::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA1209_ActiveState::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA1209_ActiveState::getAllocated(const std::string& msg,
...
bool HA1209_ActiveState::isCanceled(const std::string& msg,
...
bool HA1209_ActiveState::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA1209_ActiveState::getProperty(const std::string& msg,
...
bool HA1209_ActiveState::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA1209_ActiveState::isEnableContext(const std::string& msg,
...
bool HA1209_ActiveState::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA1209_ActiveState::isAttenuated(const std::string& msg,
...
// 0001  #start false
TEST_F(HA1209_ActiveState, false)
{
  std::list<std::string> contexts;
#ifdef RBA_USE_LOG
  std::unique_ptr < stub::StubLogCollector >
  collector = std::make_unique<stub::StubLogCollector>(JSONPATH"/HA1209_ActiveState_false.log",
                                                       LOGPATH"/HA1209_ActiveState_false.log",
                                                       true);
  logm_->addCoverageLogCollector(collector.get());
#endif
  // 0002  CL
...
// 0008  #start true
TEST_F(HA1209_ActiveState, true)
{
  std::list<std::string> contexts;
#ifdef RBA_USE_LOG
  std::unique_ptr < stub::StubLogCollector >
  collector = std::make_unique<stub::StubLogCollector>(JSONPATH"/HA1209_ActiveState_true.log",
                                                       LOGPATH"/HA1209_ActiveState_true.log",
                                                       true);
  logm_->addCoverageLogCollector(collector.get());
#endif
  // 0009  CL
...
TEST_F(HA1209_ActiveState, false_pre)
{
  std::list<std::string> contexts;
#ifdef RBA_USE_LOG
  std::unique_ptr < stub::StubLogCollector >
  collector = std::make_unique<stub::StubLogCollector>(JSONPATH"/HA1209_ActiveState_false_pre.log",
                                                       LOGPATH"/HA1209_ActiveState_false_pre.log",
                                                       true);
  logm_->addCoverageLogCollector(collector.get());
#endif
  // 0016  CL
...
// 0024  #start true_pre
TEST_F(HA1209_ActiveState, true_pre)
{
  std::list<std::string> contexts;
#ifdef RBA_USE_LOG
  std::unique_ptr < stub::StubLogCollector >
  collector = std::make_unique<stub::StubLogCollector>(JSONPATH"/HA1209_ActiveState_true_pre.log",
                                                       LOGPATH"/HA1209_ActiveState_true_pre.log",
                                                       true);
  logm_->addCoverageLogCollector(collector.get());
#endif
  // 0025  CL
...
TEST_F(HA1209_ActiveState, allocatedContent)
{
  std::list<std::string> contexts;
#ifdef RBA_USE_LOG
  std::unique_ptr < stub::StubLogCollector >
  collector = std::make_unique<stub::StubLogCollector>(JSONPATH"/HA1209_ActiveState_allocatedContent.log",
                                                       LOGPATH"/HA1209_ActiveState_allocatedContent.log",
                                                       true);
  logm_->addCoverageLogCollector(collector.get());
#endif
  // 0034  CL
