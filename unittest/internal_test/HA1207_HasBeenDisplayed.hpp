...
/**
 * HA1207_HasBeenDisplayed.hpp
 */

#ifndef HA1207_HASBEENDISPLAYED_HPP
#define HA1207_HASBEENDISPLAYED_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA1207_HasBeenDisplayed.json"

namespace {

using namespace rba;

class HA1207_HasBeenDisplayed : public ::testing::Test
{
protected:
  HA1207_HasBeenDisplayed();
  virtual ~HA1207_HasBeenDisplayed();
  virtual void SetUp();
