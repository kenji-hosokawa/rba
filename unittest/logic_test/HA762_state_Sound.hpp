...
/**
 * HA762_state_Sound.hpp
 */

#ifndef HA762_STATE_SOUND_HPP
#define HA762_STATE_SOUND_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_state_Sound.json"

namespace {

using namespace rba;

class HA762_state_Sound : public ::testing::Test
{
protected:
  HA762_state_Sound();
  virtual ~HA762_state_Sound();
  virtual void SetUp();
