...
/**
 * Implies_Content_LowToHigh.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_Content_LowToHigh.hpp"
...
Implies_Content_LowToHigh::Implies_Content_LowToHigh(void)
{
}
...
void Implies_Content_LowToHigh::SetUp(void)
{
...
void Implies_Content_LowToHigh::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_Content_LowToHigh, Test_15) {
...
TEST_F(Implies_Content_LowToHigh, Test_14) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh, Test_16) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh, Test_13) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh, Test_12) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh, Test_10) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh, Test_11) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh, Test_9) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh, Test_8) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh, Test_7) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
