...
/**
 * PreviousModifier_DisplayingContent.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "PreviousModifier_DisplayingContent.hpp"
...
PreviousModifier_DisplayingContent::PreviousModifier_DisplayingContent(void)
{
}
...
void PreviousModifier_DisplayingContent::SetUp(void)
{
...
void PreviousModifier_DisplayingContent::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(PreviousModifier_DisplayingContent, Test_1) {
