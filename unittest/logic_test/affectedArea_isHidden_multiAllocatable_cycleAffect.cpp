...
/**
 * affectedArea_isHidden_multiAllocatable_cycleAffect.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "affectedArea_isHidden_multiAllocatable_cycleAffect.hpp"
...
affectedArea_isHidden_multiAllocatable_cycleAffect::affectedArea_isHidden_multiAllocatable_cycleAffect(void)
{
}
...
void affectedArea_isHidden_multiAllocatable_cycleAffect::SetUp(void)
{
...
void affectedArea_isHidden_multiAllocatable_cycleAffect::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(affectedArea_isHidden_multiAllocatable_cycleAffect, Test_7) {
...
TEST_F(affectedArea_isHidden_multiAllocatable_cycleAffect, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_isHidden_multiAllocatable_cycleAffect, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_isHidden_multiAllocatable_cycleAffect, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_isHidden_multiAllocatable_cycleAffect, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_isHidden_multiAllocatable_cycleAffect, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_isHidden_multiAllocatable_cycleAffect, Test_8) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_isHidden_multiAllocatable_cycleAffect, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
