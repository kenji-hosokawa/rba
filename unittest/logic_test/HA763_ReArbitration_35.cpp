...
#include "HA763_ReArbitration_35.hpp"

namespace {

using namespace rba;

HA763_ReArbitration_35::HA763_ReArbitration_35() {}
HA763_ReArbitration_35::~HA763_ReArbitration_35() {}

void HA763_ReArbitration_35::SetUp()
{
...
void HA763_ReArbitration_35::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA763_ReArbitration_35::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA763_ReArbitration_35::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA763_ReArbitration_35::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA763_ReArbitration_35::getAllocated(const std::string& msg,
...
bool HA763_ReArbitration_35::isCanceled(const std::string& msg,
...
bool HA763_ReArbitration_35::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA763_ReArbitration_35::getProperty(const std::string& msg,
...
bool HA763_ReArbitration_35::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA763_ReArbitration_35::isEnableContext(const std::string& msg,
...
bool HA763_ReArbitration_35::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA763_ReArbitration_35::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA763_ReArbitration_35, Test_01)
{
