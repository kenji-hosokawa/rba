...
/**
 * Implies_Area_LowToHigh.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_Area_LowToHigh.hpp"
...
Implies_Area_LowToHigh::Implies_Area_LowToHigh(void)
{
}
...
void Implies_Area_LowToHigh::SetUp(void)
{
...
void Implies_Area_LowToHigh::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_Area_LowToHigh, Test_4) {
...
TEST_F(Implies_Area_LowToHigh, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Area_LowToHigh, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Area_LowToHigh, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
