...
/**
 * SetOfOperator_ContentSet.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "SetOfOperator_ContentSet.hpp"
...
SetOfOperator_ContentSet::SetOfOperator_ContentSet(void)
{
}
...
void SetOfOperator_ContentSet::SetUp(void)
{
...
void SetOfOperator_ContentSet::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(SetOfOperator_ContentSet, Test_test) {
