...
void IsDisplayed::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(IsDisplayed, Test_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
