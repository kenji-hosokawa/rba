...
/**
 * HA762_AllocatedContent_Hiddencheck.hpp
 */

#ifndef HA762_ALLOCATEDCONTENT_HIDDENCHECK_HPP
#define HA762_ALLOCATEDCONTENT_HIDDENCHECK_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_AllocatedContent_Hiddencheck.json"

namespace {

using namespace rba;

class HA762_AllocatedContent_Hiddencheck : public ::testing::Test
{
protected:
  HA762_AllocatedContent_Hiddencheck();
  virtual ~HA762_AllocatedContent_Hiddencheck();
  virtual void SetUp();
