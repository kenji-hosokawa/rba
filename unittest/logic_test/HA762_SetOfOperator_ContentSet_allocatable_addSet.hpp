...
/**
 * HA762_SetOfOperator_ContentSet_allocatable_addSet.hpp
 */

#ifndef HA762_SETOFOPERATOR_CONTENTSET_ALLOCATABLE_ADDSET_HPP
#define HA762_SETOFOPERATOR_CONTENTSET_ALLOCATABLE_ADDSET_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_SetOfOperator_ContentSet_allocatable_addSet.json"

namespace {

using namespace rba;

class HA762_SetOfOperator_ContentSet_allocatable_addSet : public ::testing::Test
{
protected:
  HA762_SetOfOperator_ContentSet_allocatable_addSet();
  virtual ~HA762_SetOfOperator_ContentSet_allocatable_addSet();
  virtual void SetUp();
