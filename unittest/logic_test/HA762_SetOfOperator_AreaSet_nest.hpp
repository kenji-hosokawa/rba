...
/**
 * HA762_SetOfOperator_AreaSet_nest.hpp
 */

#ifndef HA762_SETOFOPERATOR_AREASET_NEST_HPP
#define HA762_SETOFOPERATOR_AREASET_NEST_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_SetOfOperator_AreaSet_nest.json"

namespace {

using namespace rba;

class HA762_SetOfOperator_AreaSet_nest : public ::testing::Test
{
protected:
  HA762_SetOfOperator_AreaSet_nest();
  virtual ~HA762_SetOfOperator_AreaSet_nest();
  virtual void SetUp();
