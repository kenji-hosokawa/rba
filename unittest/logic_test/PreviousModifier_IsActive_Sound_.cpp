...
/**
 * PreviousModifier_IsActive_Sound_.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "PreviousModifier_IsActive_Sound_.hpp"
...
PreviousModifier_IsActive_Sound_::PreviousModifier_IsActive_Sound_(void)
{
}
...
void PreviousModifier_IsActive_Sound_::SetUp(void)
{
...
void PreviousModifier_IsActive_Sound_::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(PreviousModifier_IsActive_Sound_, Test_1) {
