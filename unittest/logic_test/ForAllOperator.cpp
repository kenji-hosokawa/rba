...
ForAllOperator::ForAllOperator(void)
{
}
...
void ForAllOperator::SetUp(void)
{
...
void ForAllOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(ForAllOperator, Test_true) {
...
TEST_F(ForAllOperator, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ForAllOperator, Test_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
