...
/**
 * HA762_OrOperator.hpp
 */

#ifndef HA762_OROPERATOR_HPP
#define HA762_OROPERATOR_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_OrOperator.json"

namespace {

using namespace rba;

class HA762_OrOperator : public ::testing::Test
{
protected:
  HA762_OrOperator();
  virtual ~HA762_OrOperator();
  virtual void SetUp();
