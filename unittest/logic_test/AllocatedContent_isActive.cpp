...
/**
 * AllocatedContent_isActive.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "AllocatedContent_isActive.hpp"
...
AllocatedContent_isActive::AllocatedContent_isActive(void)
{
}
...
void AllocatedContent_isActive::SetUp(void)
{
...
void AllocatedContent_isActive::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(AllocatedContent_isActive, Test_execption) {
...
TEST_F(AllocatedContent_isActive, Test_true) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
