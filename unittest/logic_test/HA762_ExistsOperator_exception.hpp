...
/**
 * HA762_ExistsOperator_exception.hpp
 */

#ifndef HA762_EXISTSOPERATOR_EXCEPTION_HPP
#define HA762_EXISTSOPERATOR_EXCEPTION_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_ExistsOperator_exception.json"

namespace {

using namespace rba;

class HA762_ExistsOperator_exception : public ::testing::Test
{
protected:
  HA762_ExistsOperator_exception();
  virtual ~HA762_ExistsOperator_exception();
  virtual void SetUp();
