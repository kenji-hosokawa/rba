...
/**
 * affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator.hpp"
...
affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator::affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator(void)
{
}
...
void affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator::SetUp(void)
{
...
void affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator, Test_12) {
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator, Test_10) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator, Test_11) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator, Test_9) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator, Test_8) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator, Test_7) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_byZoneOperator, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
