...
/**
 * HA762_HasComeLaterThan_DifferentZone.hpp
 */

#ifndef HA762_HASCOMELATERTHAN_DIFFERENTZONE_HPP
#define HA762_HASCOMELATERTHAN_DIFFERENTZONE_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_HasComeLaterThan_DifferentZone.json"

namespace {

using namespace rba;

class HA762_HasComeLaterThan_DifferentZone : public ::testing::Test
{
protected:
  HA762_HasComeLaterThan_DifferentZone();
  virtual ~HA762_HasComeLaterThan_DifferentZone();
  virtual void SetUp();
