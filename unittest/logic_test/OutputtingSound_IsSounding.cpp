...
/**
 * OutputtingSound_IsSounding.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "OutputtingSound_IsSounding.hpp"
...
OutputtingSound_IsSounding::OutputtingSound_IsSounding(void)
{
}
...
void OutputtingSound_IsSounding::SetUp(void)
{
...
void OutputtingSound_IsSounding::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(OutputtingSound_IsSounding, Test_exception) {
...
TEST_F(OutputtingSound_IsSounding, Test_true) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
