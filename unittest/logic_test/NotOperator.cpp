...
void NotOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(NotOperator, Test_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
