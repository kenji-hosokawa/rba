...
/**
 * PreviousModifier_ContentValue.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "PreviousModifier_ContentValue.hpp"
...
PreviousModifier_ContentValue::PreviousModifier_ContentValue(void)
{
}
...
void PreviousModifier_ContentValue::SetUp(void)
{
...
void PreviousModifier_ContentValue::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(PreviousModifier_ContentValue, Test_1) {
