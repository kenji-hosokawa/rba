...
/**
 * Implies_Chain_Content_MiddleToHighToLow.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_Chain_Content_MiddleToHighToLow.hpp"
...
Implies_Chain_Content_MiddleToHighToLow::Implies_Chain_Content_MiddleToHighToLow(void)
{
}
...
void Implies_Chain_Content_MiddleToHighToLow::SetUp(void)
{
...
void Implies_Chain_Content_MiddleToHighToLow::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_Chain_Content_MiddleToHighToLow, Test_12) {
...
TEST_F(Implies_Chain_Content_MiddleToHighToLow, Test_10) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Content_MiddleToHighToLow, Test_11) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Content_MiddleToHighToLow, Test_9) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Content_MiddleToHighToLow, Test_8) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Content_MiddleToHighToLow, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Content_MiddleToHighToLow, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Content_MiddleToHighToLow, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Content_MiddleToHighToLow, Test_7) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Content_MiddleToHighToLow, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Content_MiddleToHighToLow, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Content_MiddleToHighToLow, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
