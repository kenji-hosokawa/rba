...
/**
 * DisplayingContent_IsVisible.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "DisplayingContent_IsVisible.hpp"
...
DisplayingContent_IsVisible::DisplayingContent_IsVisible(void)
{
}
...
void DisplayingContent_IsVisible::SetUp(void)
{
...
void DisplayingContent_IsVisible::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(DisplayingContent_IsVisible, Test_exception) {
...
TEST_F(DisplayingContent_IsVisible, Test_true) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
