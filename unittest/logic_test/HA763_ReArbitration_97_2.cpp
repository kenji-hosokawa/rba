...
#include "HA763_ReArbitration_97_2.hpp"

namespace {

using namespace rba;

HA763_ReArbitration_97_2::HA763_ReArbitration_97_2() {}
HA763_ReArbitration_97_2::~HA763_ReArbitration_97_2() {}

void HA763_ReArbitration_97_2::SetUp()
{
...
void HA763_ReArbitration_97_2::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA763_ReArbitration_97_2::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA763_ReArbitration_97_2::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA763_ReArbitration_97_2::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA763_ReArbitration_97_2::getAllocated(const std::string& msg,
...
bool HA763_ReArbitration_97_2::isCanceled(const std::string& msg,
...
bool HA763_ReArbitration_97_2::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA763_ReArbitration_97_2::getProperty(const std::string& msg,
...
bool HA763_ReArbitration_97_2::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA763_ReArbitration_97_2::isEnableContext(const std::string& msg,
...
bool HA763_ReArbitration_97_2::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA763_ReArbitration_97_2::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA763_ReArbitration_97_2, Test_01)
{
...
// 0010  #start 2
TEST_F(HA763_ReArbitration_97_2, Test_02)
{
  std::list<std::string> contexts;
  ...
  // 0015  Assert,A,A,A1
  EXPECT_EQ(u8"A1",getAllocated("line=15", u8"A"));
  // 0016  Assert,A,B,
  EXPECT_EQ(u8"",getAllocated("line=16", u8"B"));
  // 0017  Assert,A,C,
  EXPECT_EQ(u8"",getAllocated("line=17", u8"C"));
  // 0018  Assert,A,D,D1
  EXPECT_EQ(u8"D1",getAllocated("line=18", u8"D"));
}

// 0020  #start 3
TEST_F(HA763_ReArbitration_97_2, Test_03)
{
  std::list<std::string> contexts;
  ...
  // 0027  Assert,A,B,B1
  EXPECT_EQ(u8"B1",getAllocated("line=27", u8"B"));
  // 0028  Assert,A,C,C1
  EXPECT_EQ(u8"C1",getAllocated("line=28", u8"C"));
  // 0029  Assert,A,D,D1
  EXPECT_EQ(u8"D1",getAllocated("line=29", u8"D"));
}
