...
/**
 * HA762_HasComeLaterThan_SameArea2.cpp
 */
...
#include "HA762_HasComeLaterThan_SameArea2.hpp"

namespace {

using namespace rba;

HA762_HasComeLaterThan_SameArea2::HA762_HasComeLaterThan_SameArea2() {}
HA762_HasComeLaterThan_SameArea2::~HA762_HasComeLaterThan_SameArea2() {}

void HA762_HasComeLaterThan_SameArea2::SetUp()
{
...
void HA762_HasComeLaterThan_SameArea2::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_HasComeLaterThan_SameArea2::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_HasComeLaterThan_SameArea2::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_HasComeLaterThan_SameArea2::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_HasComeLaterThan_SameArea2::getAllocated(const std::string& msg,
...
bool HA762_HasComeLaterThan_SameArea2::isCanceled(const std::string& msg,
...
bool HA762_HasComeLaterThan_SameArea2::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_HasComeLaterThan_SameArea2::getProperty(const std::string& msg,
...
bool HA762_HasComeLaterThan_SameArea2::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_HasComeLaterThan_SameArea2::isEnableContext(const std::string& msg,
...
bool HA762_HasComeLaterThan_SameArea2::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_HasComeLaterThan_SameArea2::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_HasComeLaterThan_SameArea2, Test_01)
{
...
// 0013  #start 2
TEST_F(HA762_HasComeLaterThan_SameArea2, Test_02)
{
  std::list<std::string> contexts;
...
// 0035  #start 3
TEST_F(HA762_HasComeLaterThan_SameArea2, Test_03)
{
  std::list<std::string> contexts;
