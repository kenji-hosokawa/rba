...
/**
 * HA762_HasComeLaterThan_Usecase.hpp
 */

#ifndef HA762_HASCOMELATERTHAN_USECASE_HPP
#define HA762_HASCOMELATERTHAN_USECASE_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_HasComeLaterThan_Usecase.json"

namespace {

using namespace rba;

class HA762_HasComeLaterThan_Usecase : public ::testing::Test
{
protected:
  HA762_HasComeLaterThan_Usecase();
  virtual ~HA762_HasComeLaterThan_Usecase();
  virtual void SetUp();
