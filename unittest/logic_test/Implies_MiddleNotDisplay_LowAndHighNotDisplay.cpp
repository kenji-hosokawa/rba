...
/**
 * Implies_MiddleNotDisplay_LowAndHighNotDisplay.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_MiddleNotDisplay_LowAndHighNotDisplay.hpp"
...
Implies_MiddleNotDisplay_LowAndHighNotDisplay::Implies_MiddleNotDisplay_LowAndHighNotDisplay(void)
{
}
...
void Implies_MiddleNotDisplay_LowAndHighNotDisplay::SetUp(void)
{
...
void Implies_MiddleNotDisplay_LowAndHighNotDisplay::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_MiddleNotDisplay_LowAndHighNotDisplay, Test_1) {
...
TEST_F(Implies_MiddleNotDisplay_LowAndHighNotDisplay, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MiddleNotDisplay_LowAndHighNotDisplay, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MiddleNotDisplay_LowAndHighNotDisplay, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MiddleNotDisplay_LowAndHighNotDisplay, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MiddleNotDisplay_LowAndHighNotDisplay, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MiddleNotDisplay_LowAndHighNotDisplay, Test_7) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MiddleNotDisplay_LowAndHighNotDisplay, Test_8) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
