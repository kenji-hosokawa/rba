...
/**
 * PreviousModifier_IsAttenuated.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "PreviousModifier_IsAttenuated.hpp"
...
PreviousModifier_IsAttenuated::PreviousModifier_IsAttenuated(void)
{
}
...
void PreviousModifier_IsAttenuated::SetUp(void)
{
...
void PreviousModifier_IsAttenuated::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(PreviousModifier_IsAttenuated, Test_true) {
  ...
  elems = {u8"Assert",u8"A",u8"ゾーンC",u8"コンテンツC1"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
...
TEST_F(PreviousModifier_IsAttenuated, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
