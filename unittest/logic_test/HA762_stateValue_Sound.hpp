...
/**
 * HA762_stateValue_Sound.hpp
 */

#ifndef HA762_STATEVALUE_SOUND_HPP
#define HA762_STATEVALUE_SOUND_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_stateValue_Sound.json"

namespace {

using namespace rba;

class HA762_stateValue_Sound : public ::testing::Test
{
protected:
  HA762_stateValue_Sound();
  virtual ~HA762_stateValue_Sound();
  virtual void SetUp();
