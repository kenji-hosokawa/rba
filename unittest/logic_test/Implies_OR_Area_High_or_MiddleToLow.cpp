/**
 * Implies_OR_Area_High_or_MiddleToLow.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_OR_Area_High_or_MiddleToLow.hpp"
...
Implies_OR_Area_High_or_MiddleToLow::Implies_OR_Area_High_or_MiddleToLow(void)
{
}
...
void Implies_OR_Area_High_or_MiddleToLow::SetUp(void)
{
...
void Implies_OR_Area_High_or_MiddleToLow::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_OR_Area_High_or_MiddleToLow, Test_1) {
...
TEST_F(Implies_OR_Area_High_or_MiddleToLow, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_High_or_MiddleToLow, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_High_or_MiddleToLow, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_High_or_MiddleToLow, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_High_or_MiddleToLow, Test_ReadMe) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;


}
TEST_F(Implies_OR_Area_High_or_MiddleToLow, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
