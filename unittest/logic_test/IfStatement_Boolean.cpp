...
/**
 * IfStatement_Boolean.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "IfStatement_Boolean.hpp"
...
IfStatement_Boolean::IfStatement_Boolean(void)
{
}
...
void IfStatement_Boolean::SetUp(void)
{
...
void IfStatement_Boolean::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(IfStatement_Boolean, Test_ELSE_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;

  elems = {u8"C",u8"ON",u8"コンテンツD1",u8"NORMAL"};
  {
...
TEST_F(IfStatement_Boolean, Test_THEN_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_Boolean, Test_ELSE_true) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_Boolean, Test_ELSE_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_Boolean, Test_THEN_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_Boolean, Test_THEN_true) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
