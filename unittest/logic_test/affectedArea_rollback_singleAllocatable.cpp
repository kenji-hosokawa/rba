...
/**
 * affectedArea_rollback_singleAllocatable.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "affectedArea_rollback_singleAllocatable.hpp"
...
affectedArea_rollback_singleAllocatable::affectedArea_rollback_singleAllocatable(void)
{
}
...
void affectedArea_rollback_singleAllocatable::SetUp(void)
{
...
void affectedArea_rollback_singleAllocatable::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(affectedArea_rollback_singleAllocatable, Test_7) {
...
TEST_F(affectedArea_rollback_singleAllocatable, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_rollback_singleAllocatable, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_rollback_singleAllocatable, Test_12) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_rollback_singleAllocatable, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_rollback_singleAllocatable, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_rollback_singleAllocatable, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_rollback_singleAllocatable, Test_8) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_rollback_singleAllocatable, Test_11) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_rollback_singleAllocatable, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_rollback_singleAllocatable, Test_9) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_rollback_singleAllocatable, Test_10) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
