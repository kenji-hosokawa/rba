...
/**
 * HA762_ObjectCompare_exception.hpp
 */

#ifndef HA762_OBJECTCOMPARE_EXCEPTION_HPP
#define HA762_OBJECTCOMPARE_EXCEPTION_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_ObjectCompare_exception.json"

namespace {

using namespace rba;

class HA762_ObjectCompare_exception : public ::testing::Test
{
protected:
  HA762_ObjectCompare_exception();
  virtual ~HA762_ObjectCompare_exception();
  virtual void SetUp();
