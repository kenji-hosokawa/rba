...
/**
 * PreviousModifier_IsVisible.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "PreviousModifier_IsVisible.hpp"
...
PreviousModifier_IsVisible::PreviousModifier_IsVisible(void)
{
}
...
void PreviousModifier_IsVisible::SetUp(void)
{
...
void PreviousModifier_IsVisible::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(PreviousModifier_IsVisible, Test_1) {
