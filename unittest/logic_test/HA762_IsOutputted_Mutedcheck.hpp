...
/**
 * HA762_IsOutputted_Mutedcheck.hpp
 */

#ifndef HA762_ISOUTPUTTED_MUTEDCHECK_HPP
#define HA762_ISOUTPUTTED_MUTEDCHECK_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_IsOutputted_Mutedcheck.json"

namespace {

using namespace rba;

class HA762_IsOutputted_Mutedcheck : public ::testing::Test
{
protected:
  HA762_IsOutputted_Mutedcheck();
  virtual ~HA762_IsOutputted_Mutedcheck();
  virtual void SetUp();
