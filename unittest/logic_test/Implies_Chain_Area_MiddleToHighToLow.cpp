...
/**
 * Implies_Chain_Area_MiddleToHighToLow.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_Chain_Area_MiddleToHighToLow.hpp"
...
Implies_Chain_Area_MiddleToHighToLow::Implies_Chain_Area_MiddleToHighToLow(void)
{
}
...
void Implies_Chain_Area_MiddleToHighToLow::SetUp(void)
{
...
void Implies_Chain_Area_MiddleToHighToLow::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_Chain_Area_MiddleToHighToLow, Test_5) {
...
TEST_F(Implies_Chain_Area_MiddleToHighToLow, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_MiddleToHighToLow, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_MiddleToHighToLow, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_MiddleToHighToLow, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_MiddleToHighToLow, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
