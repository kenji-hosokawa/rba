...
/**
 * HA762_HasComeLaterThan_SameContent.hpp
 */

#ifndef HA762_HASCOMELATERTHAN_SAMECONTENT_HPP
#define HA762_HASCOMELATERTHAN_SAMECONTENT_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_HasComeLaterThan_SameContent.json"

namespace {

using namespace rba;

class HA762_HasComeLaterThan_SameContent : public ::testing::Test
{
protected:
  HA762_HasComeLaterThan_SameContent();
  virtual ~HA762_HasComeLaterThan_SameContent();
  virtual void SetUp();
