...
/**
 * HA762_HasComeLaterThan_Usecase_Sound.cpp
 */
...
#include "HA762_HasComeLaterThan_Usecase_Sound.hpp"

namespace {

using namespace rba;

HA762_HasComeLaterThan_Usecase_Sound::HA762_HasComeLaterThan_Usecase_Sound() {}
HA762_HasComeLaterThan_Usecase_Sound::~HA762_HasComeLaterThan_Usecase_Sound() {}

void HA762_HasComeLaterThan_Usecase_Sound::SetUp()
{
...
void HA762_HasComeLaterThan_Usecase_Sound::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_HasComeLaterThan_Usecase_Sound::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_HasComeLaterThan_Usecase_Sound::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_HasComeLaterThan_Usecase_Sound::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_HasComeLaterThan_Usecase_Sound::getAllocated(const std::string& msg,
...
bool HA762_HasComeLaterThan_Usecase_Sound::isCanceled(const std::string& msg,
...
bool HA762_HasComeLaterThan_Usecase_Sound::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_HasComeLaterThan_Usecase_Sound::getProperty(const std::string& msg,
...
bool HA762_HasComeLaterThan_Usecase_Sound::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_HasComeLaterThan_Usecase_Sound::isEnableContext(const std::string& msg,
...
bool HA762_HasComeLaterThan_Usecase_Sound::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_HasComeLaterThan_Usecase_Sound::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_HasComeLaterThan_Usecase_Sound, Test_01)
{
...
// 0007  #start 2
TEST_F(HA762_HasComeLaterThan_Usecase_Sound, Test_02)
{
  std::list<std::string> contexts;
...
// 0013  #start 3
TEST_F(HA762_HasComeLaterThan_Usecase_Sound, Test_03)
{
  std::list<std::string> contexts;
...
// 0020  #start 4
TEST_F(HA762_HasComeLaterThan_Usecase_Sound, Test_04)
{
  std::list<std::string> contexts;
