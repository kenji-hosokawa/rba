...
/**
 * PreviousModifier_IsDisplayed.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "PreviousModifier_IsDisplayed.hpp"
...
PreviousModifier_IsDisplayed::PreviousModifier_IsDisplayed(void)
{
}
...
void PreviousModifier_IsDisplayed::SetUp(void)
{
...
void PreviousModifier_IsDisplayed::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(PreviousModifier_IsDisplayed, Test_1) {
