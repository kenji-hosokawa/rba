...
/**
 * Implies_AND_Area_High_and_LowToMiddle.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_AND_Area_High_and_LowToMiddle.hpp"
...
Implies_AND_Area_High_and_LowToMiddle::Implies_AND_Area_High_and_LowToMiddle(void)
{
}
...
void Implies_AND_Area_High_and_LowToMiddle::SetUp(void)
{
...
void Implies_AND_Area_High_and_LowToMiddle::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_AND_Area_High_and_LowToMiddle, Test_5) {
...
TEST_F(Implies_AND_Area_High_and_LowToMiddle, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_High_and_LowToMiddle, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_High_and_LowToMiddle, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_High_and_LowToMiddle, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_High_and_LowToMiddle, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
