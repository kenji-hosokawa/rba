...
GetContentsList::GetContentsList(void)
{
}
...
void GetContentsList::SetUp(void)
{
...
void GetContentsList::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(GetContentsList, Test_get) {
