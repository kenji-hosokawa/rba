...
/**
 * HA762_ImpliesOperator_exception.hpp
 */

#ifndef HA762_IMPLIESOPERATOR_EXCEPTION_HPP
#define HA762_IMPLIESOPERATOR_EXCEPTION_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_ImpliesOperator_exception.json"

namespace {

using namespace rba;

class HA762_ImpliesOperator_exception : public ::testing::Test
{
protected:
  HA762_ImpliesOperator_exception();
  virtual ~HA762_ImpliesOperator_exception();
  virtual void SetUp();
