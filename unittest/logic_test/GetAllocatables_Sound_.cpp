...
/**
 * GetAllocatables_Sound_.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "GetAllocatables_Sound_.hpp"
...
GetAllocatables_Sound_::GetAllocatables_Sound_(void)
{
}
...
void GetAllocatables_Sound_::SetUp(void)
{
...
void GetAllocatables_Sound_::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(GetAllocatables_Sound_, Test_get) {
  ...
  elems = {u8"Assert",u8"A",u8"AllocatableB",u8"ContentA1"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
