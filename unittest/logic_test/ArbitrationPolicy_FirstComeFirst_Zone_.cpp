...
/**
 * ArbitrationPolicy_FirstComeFirst_Zone_.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "ArbitrationPolicy_FirstComeFirst_Zone_.hpp"
...
ArbitrationPolicy_FirstComeFirst_Zone_::ArbitrationPolicy_FirstComeFirst_Zone_(void)
{
}
...
void ArbitrationPolicy_FirstComeFirst_Zone_::SetUp(void)
{
...
void ArbitrationPolicy_FirstComeFirst_Zone_::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(ArbitrationPolicy_FirstComeFirst_Zone_, Test_basic) {
