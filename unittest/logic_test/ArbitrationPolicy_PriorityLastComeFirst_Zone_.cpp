...
/**
 * ArbitrationPolicy_PriorityLastComeFirst_Zone_.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "ArbitrationPolicy_PriorityLastComeFirst_Zone_.hpp"
...
ArbitrationPolicy_PriorityLastComeFirst_Zone_::ArbitrationPolicy_PriorityLastComeFirst_Zone_(void)
{
}
...
void ArbitrationPolicy_PriorityLastComeFirst_Zone_::SetUp(void)
{
...
void ArbitrationPolicy_PriorityLastComeFirst_Zone_::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(ArbitrationPolicy_PriorityLastComeFirst_Zone_, Test_basic) {
