...
/**
 * DisplayingContent_isActive.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "DisplayingContent_isActive.hpp"
...
DisplayingContent_isActive::DisplayingContent_isActive(void)
{
}
...
void DisplayingContent_isActive::SetUp(void)
{
...
void DisplayingContent_isActive::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(DisplayingContent_isActive, Test_execption) {
...
TEST_F(DisplayingContent_isActive, Test_true) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
