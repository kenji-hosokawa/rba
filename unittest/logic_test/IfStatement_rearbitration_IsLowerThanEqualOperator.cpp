...
/**
 * IfStatement_rearbitration_IsLowerThanEqualOperator.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "IfStatement_rearbitration_IsLowerThanEqualOperator.hpp"
...
IfStatement_rearbitration_IsLowerThanEqualOperator::IfStatement_rearbitration_IsLowerThanEqualOperator(void)
{
}
...
void IfStatement_rearbitration_IsLowerThanEqualOperator::SetUp(void)
{
...
void IfStatement_rearbitration_IsLowerThanEqualOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(IfStatement_rearbitration_IsLowerThanEqualOperator, Test_AisEqualToB_BisHidden) {
...
TEST_F(IfStatement_rearbitration_IsLowerThanEqualOperator, Test_AisGreaterThanB_AisHidden) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_rearbitration_IsLowerThanEqualOperator, Test_AisLowerThanB_BisHidden) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_rearbitration_IsLowerThanEqualOperator, Test_Aonly) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_rearbitration_IsLowerThanEqualOperator, Test_Bonly) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
