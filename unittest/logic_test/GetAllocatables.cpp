...
GetAllocatables::GetAllocatables(void)
{
}
...
void GetAllocatables::SetUp(void)
{
...
void GetAllocatables::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(GetAllocatables, Test_get) {
  ...
  elems = {u8"Assert",u8"A",u8"エリアB",u8"コンテンツA1"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
