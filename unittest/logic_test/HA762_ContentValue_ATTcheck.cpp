...
/**
 * HA762_ContentValue_ATTcheck.cpp
 */
...
#include "HA762_ContentValue_ATTcheck.hpp"

namespace {

using namespace rba;

HA762_ContentValue_ATTcheck::HA762_ContentValue_ATTcheck() {}
HA762_ContentValue_ATTcheck::~HA762_ContentValue_ATTcheck() {}

void HA762_ContentValue_ATTcheck::SetUp()
{
...
void HA762_ContentValue_ATTcheck::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_ContentValue_ATTcheck::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_ContentValue_ATTcheck::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_ContentValue_ATTcheck::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_ContentValue_ATTcheck::getAllocated(const std::string& msg,
...
bool HA762_ContentValue_ATTcheck::isCanceled(const std::string& msg,
...
bool HA762_ContentValue_ATTcheck::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_ContentValue_ATTcheck::getProperty(const std::string& msg,
...
bool HA762_ContentValue_ATTcheck::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_ContentValue_ATTcheck::isEnableContext(const std::string& msg,
...
bool HA762_ContentValue_ATTcheck::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_ContentValue_ATTcheck::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_ContentValue_ATTcheck, Test_01)
{
