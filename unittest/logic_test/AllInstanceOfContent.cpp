...
/**
 * AllInstanceOfContent.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "AllInstanceOfContent.hpp"
...
AllInstanceOfContent::AllInstanceOfContent(void)
{
}
...
void AllInstanceOfContent::SetUp(void)
{
...
void AllInstanceOfContent::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(AllInstanceOfContent, Test_get) {
