...
/**
 * IsGreaterThanOperator.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "IsGreaterThanOperator.hpp"
...
IsGreaterThanOperator::IsGreaterThanOperator(void)
{
}
...
void IsGreaterThanOperator::SetUp(void)
{
...
void IsGreaterThanOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(IsGreaterThanOperator, Test_true) {
...
TEST_F(IsGreaterThanOperator, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
