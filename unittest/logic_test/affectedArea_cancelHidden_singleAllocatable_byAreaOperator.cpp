...
/**
 * affectedArea_cancelHidden_singleAllocatable_byAreaOperator.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "affectedArea_cancelHidden_singleAllocatable_byAreaOperator.hpp"
...
affectedArea_cancelHidden_singleAllocatable_byAreaOperator::affectedArea_cancelHidden_singleAllocatable_byAreaOperator(void)
{
}
...
void affectedArea_cancelHidden_singleAllocatable_byAreaOperator::SetUp(void)
{
...
void affectedArea_cancelHidden_singleAllocatable_byAreaOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byAreaOperator, Test_12) {
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byAreaOperator, Test_10) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byAreaOperator, Test_11) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byAreaOperator, Test_9) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byAreaOperator, Test_8) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byAreaOperator, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byAreaOperator, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byAreaOperator, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byAreaOperator, Test_7) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byAreaOperator, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byAreaOperator, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byAreaOperator, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
