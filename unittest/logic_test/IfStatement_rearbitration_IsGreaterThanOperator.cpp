...
/**
 * IfStatement_rearbitration_IsGreaterThanOperator.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "IfStatement_rearbitration_IsGreaterThanOperator.hpp"
...
IfStatement_rearbitration_IsGreaterThanOperator::IfStatement_rearbitration_IsGreaterThanOperator(void)
{
}
...
void IfStatement_rearbitration_IsGreaterThanOperator::SetUp(void)
{
...
void IfStatement_rearbitration_IsGreaterThanOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(IfStatement_rearbitration_IsGreaterThanOperator, Test_AisEqualToB_AisHidden) {
...
TEST_F(IfStatement_rearbitration_IsGreaterThanOperator, Test_AisGreaterThanB_BisHidden) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_rearbitration_IsGreaterThanOperator, Test_AisLowerThanB_AisHidden) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_rearbitration_IsGreaterThanOperator, Test_Aonly) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_rearbitration_IsGreaterThanOperator, Test_Bonly) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
