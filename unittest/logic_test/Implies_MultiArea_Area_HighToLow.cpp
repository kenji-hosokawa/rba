...
/**
 * Implies_MultiArea_Area_HighToLow.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_MultiArea_Area_HighToLow.hpp"
...
Implies_MultiArea_Area_HighToLow::Implies_MultiArea_Area_HighToLow(void)
{
}
...
void Implies_MultiArea_Area_HighToLow::SetUp(void)
{
...
void Implies_MultiArea_Area_HighToLow::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_MultiArea_Area_HighToLow, Test_4) {
...
TEST_F(Implies_MultiArea_Area_HighToLow, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MultiArea_Area_HighToLow, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MultiArea_Area_HighToLow, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
