...
/**
 * IsEqualToOperator.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "IsEqualToOperator.hpp"
...
IsEqualToOperator::IsEqualToOperator(void)
{
}
...
void IsEqualToOperator::SetUp(void)
{
...
void IsEqualToOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(IsEqualToOperator, Test_true) {
...
TEST_F(IsEqualToOperator, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
