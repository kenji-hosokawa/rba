...
/**
 * SetOfOperator_SoundContent.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "SetOfOperator_SoundContent.hpp"
...
SetOfOperator_SoundContent::SetOfOperator_SoundContent(void)
{
}
...
void SetOfOperator_SoundContent::SetUp(void)
{
...
void SetOfOperator_SoundContent::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(SetOfOperator_SoundContent, Test_true) {
  ...
  elems = {u8"Assert",u8"A",u8"ゾーンC",u8"NULL"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"ゾーンD",u8"NULL"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"ゾーンE",u8"コンテンツE1"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
...
TEST_F(SetOfOperator_SoundContent, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
  ...
  elems = {u8"Assert",u8"A",u8"ゾーンE",u8"NULL"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
...
TEST_F(SetOfOperator_SoundContent, Test_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
