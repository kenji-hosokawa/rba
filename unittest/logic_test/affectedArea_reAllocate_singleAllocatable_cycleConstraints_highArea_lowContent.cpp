...
/**
 * affectedArea_reAllocate_singleAllocatable_cycleConstraints_highArea_lowContent.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "affectedArea_reAllocate_singleAllocatable_cycleConstraints_highArea_lowContent.hpp"
...
affectedArea_reAllocate_singleAllocatable_cycleConstraints_highArea_lowContent::affectedArea_reAllocate_singleAllocatable_cycleConstraints_highArea_lowContent(void)
{
}
...
void affectedArea_reAllocate_singleAllocatable_cycleConstraints_highArea_lowContent::SetUp(void)
{
...
void affectedArea_reAllocate_singleAllocatable_cycleConstraints_highArea_lowContent::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(affectedArea_reAllocate_singleAllocatable_cycleConstraints_highArea_lowContent, Test_1) {
