...
/**
 * Implies_Chain_Area_MiddleToLowToHigh.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_Chain_Area_MiddleToLowToHigh.hpp"
...
Implies_Chain_Area_MiddleToLowToHigh::Implies_Chain_Area_MiddleToLowToHigh(void)
{
}
...
void Implies_Chain_Area_MiddleToLowToHigh::SetUp(void)
{
...
void Implies_Chain_Area_MiddleToLowToHigh::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_Chain_Area_MiddleToLowToHigh, Test_5) {
...
TEST_F(Implies_Chain_Area_MiddleToLowToHigh, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_MiddleToLowToHigh, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_MiddleToLowToHigh, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_MiddleToLowToHigh, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_MiddleToLowToHigh, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
