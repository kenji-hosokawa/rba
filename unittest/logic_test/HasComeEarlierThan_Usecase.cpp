...
/**
 * HasComeEarlierThan_Usecase.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HasComeEarlierThan_Usecase.hpp"
...
HasComeEarlierThan_Usecase::HasComeEarlierThan_Usecase(void)
{
}
...
void HasComeEarlierThan_Usecase::SetUp(void)
{
...
void HasComeEarlierThan_Usecase::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HasComeEarlierThan_Usecase, Test_TwoRequests1) {
...
TEST_F(HasComeEarlierThan_Usecase, Test_TwoRequests2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeEarlierThan_Usecase, Test_OneRequest2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeEarlierThan_Usecase, Test_OneRequest1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
