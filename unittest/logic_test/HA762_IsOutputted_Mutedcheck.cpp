...
/**
 * HA762_IsOutputted_Mutedcheck.cpp
 */
...
#include "HA762_IsOutputted_Mutedcheck.hpp"

namespace {

using namespace rba;

HA762_IsOutputted_Mutedcheck::HA762_IsOutputted_Mutedcheck() {}
HA762_IsOutputted_Mutedcheck::~HA762_IsOutputted_Mutedcheck() {}

void HA762_IsOutputted_Mutedcheck::SetUp()
{
...
void HA762_IsOutputted_Mutedcheck::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_IsOutputted_Mutedcheck::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_IsOutputted_Mutedcheck::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_IsOutputted_Mutedcheck::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_IsOutputted_Mutedcheck::getAllocated(const std::string& msg,
...
bool HA762_IsOutputted_Mutedcheck::isCanceled(const std::string& msg,
...
bool HA762_IsOutputted_Mutedcheck::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_IsOutputted_Mutedcheck::getProperty(const std::string& msg,
...
bool HA762_IsOutputted_Mutedcheck::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_IsOutputted_Mutedcheck::isEnableContext(const std::string& msg,
...
bool HA762_IsOutputted_Mutedcheck::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_IsOutputted_Mutedcheck::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_IsOutputted_Mutedcheck, Test_01)
{
