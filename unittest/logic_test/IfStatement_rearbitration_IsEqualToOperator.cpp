...
/**
 * IfStatement_rearbitration_IsEqualToOperator.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "IfStatement_rearbitration_IsEqualToOperator.hpp"
...
IfStatement_rearbitration_IsEqualToOperator::IfStatement_rearbitration_IsEqualToOperator(void)
{
}
...
void IfStatement_rearbitration_IsEqualToOperator::SetUp(void)
{
...
void IfStatement_rearbitration_IsEqualToOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(IfStatement_rearbitration_IsEqualToOperator, Test_AisEqualToB_BisHidden) {
...
TEST_F(IfStatement_rearbitration_IsEqualToOperator, Test_AisGreaterThanB_AisHidden) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_rearbitration_IsEqualToOperator, Test_AisLowerThanB_AisHidden) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_rearbitration_IsEqualToOperator, Test_Aonly) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_rearbitration_IsEqualToOperator, Test_Bonly) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
