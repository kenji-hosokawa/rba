...
/**
 * AllocatedContent_Sound_.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "AllocatedContent_Sound_.hpp"
...
AllocatedContent_Sound_::AllocatedContent_Sound_(void)
{
}
...
void AllocatedContent_Sound_::SetUp(void)
{
...
void AllocatedContent_Sound_::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(AllocatedContent_Sound_, Test_mutedContentValue) {
  ...
  elems = {u8"Assert",u8"A",u8"ゾーンA",u8"コンテントA1"};
  {
    std::string kind = elems[1];
...
TEST_F(AllocatedContent_Sound_, Test_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
  ...
  elems = {u8"Assert",u8"A",u8"ゾーンC",u8"コンテントC3"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
