...
/**
 * HA762_HasComeLaterThan_DifferentZone_requests.hpp
 */

#ifndef HA762_HASCOMELATERTHAN_DIFFERENTZONE_REQUESTS_HPP
#define HA762_HASCOMELATERTHAN_DIFFERENTZONE_REQUESTS_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_HasComeLaterThan_DifferentZone_requests.json"

namespace {

using namespace rba;

class HA762_HasComeLaterThan_DifferentZone_requests : public ::testing::Test
{
protected:
  HA762_HasComeLaterThan_DifferentZone_requests();
  virtual ~HA762_HasComeLaterThan_DifferentZone_requests();
  virtual void SetUp();
