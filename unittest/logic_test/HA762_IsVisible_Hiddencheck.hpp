...
/**
 * HA762_IsVisible_Hiddencheck.hpp
 */

#ifndef HA762_ISVISIBLE_HIDDENCHECK_HPP
#define HA762_ISVISIBLE_HIDDENCHECK_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_IsVisible_Hiddencheck.json"

namespace {

using namespace rba;

class HA762_IsVisible_Hiddencheck : public ::testing::Test
{
protected:
  HA762_IsVisible_Hiddencheck();
  virtual ~HA762_IsVisible_Hiddencheck();
  virtual void SetUp();
