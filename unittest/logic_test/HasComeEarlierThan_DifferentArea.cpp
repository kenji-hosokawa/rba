...
/**
 * HasComeEarlierThan_DifferentArea.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HasComeEarlierThan_DifferentArea.hpp"
...
HasComeEarlierThan_DifferentArea::HasComeEarlierThan_DifferentArea(void)
{
}
...
void HasComeEarlierThan_DifferentArea::SetUp(void)
{
...
void HasComeEarlierThan_DifferentArea::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HasComeEarlierThan_DifferentArea, Test_TwoRequests1) {
...
TEST_F(HasComeEarlierThan_DifferentArea, Test_TwoRequests2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeEarlierThan_DifferentArea, Test_OneRequest2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeEarlierThan_DifferentArea, Test_OneRequest1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
