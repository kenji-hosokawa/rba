...
/**
 * HA762_HasComeEarlierThan_SameZone2.hpp
 */

#ifndef HA762_HASCOMEEARLIERTHAN_SAMEZONE2_HPP
#define HA762_HASCOMEEARLIERTHAN_SAMEZONE2_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_HasComeEarlierThan_SameZone2.json"

namespace {

using namespace rba;

class HA762_HasComeEarlierThan_SameZone2 : public ::testing::Test
{
protected:
  HA762_HasComeEarlierThan_SameZone2();
  virtual ~HA762_HasComeEarlierThan_SameZone2();
  virtual void SetUp();
