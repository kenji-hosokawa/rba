...
IsAttenuated::IsAttenuated(void)
{
}
...
void IsAttenuated::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(IsAttenuated, Test_exception_false_true) {
