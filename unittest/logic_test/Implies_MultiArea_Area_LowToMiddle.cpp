...
/**
 * Implies_MultiArea_Area_LowToMiddle.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_MultiArea_Area_LowToMiddle.hpp"
...
Implies_MultiArea_Area_LowToMiddle::Implies_MultiArea_Area_LowToMiddle(void)
{
}
...
void Implies_MultiArea_Area_LowToMiddle::SetUp(void)
{
...
void Implies_MultiArea_Area_LowToMiddle::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_MultiArea_Area_LowToMiddle, Test_4) {
...
TEST_F(Implies_MultiArea_Area_LowToMiddle, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MultiArea_Area_LowToMiddle, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MultiArea_Area_LowToMiddle, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
