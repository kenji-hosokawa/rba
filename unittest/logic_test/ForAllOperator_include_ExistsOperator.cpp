...
/**
 * ForAllOperator_include_ExistsOperator.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "ForAllOperator_include_ExistsOperator.hpp"
...
ForAllOperator_include_ExistsOperator::ForAllOperator_include_ExistsOperator(void)
{
}
...
void ForAllOperator_include_ExistsOperator::SetUp(void)
{
...
void ForAllOperator_include_ExistsOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(ForAllOperator_include_ExistsOperator, Test_9) {
  ...
  elems = {u8"Assert",u8"A",u8"エリアA",u8"コンテンツA3"};
  {
    std::string kind = elems[1];
  ...
  elems = {u8"Assert",u8"A",u8"エリアB",u8"コンテンツB3"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
...
TEST_F(ForAllOperator_include_ExistsOperator, Test_8) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ForAllOperator_include_ExistsOperator, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ForAllOperator_include_ExistsOperator, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ForAllOperator_include_ExistsOperator, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ForAllOperator_include_ExistsOperator, Test_7) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ForAllOperator_include_ExistsOperator, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ForAllOperator_include_ExistsOperator, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ForAllOperator_include_ExistsOperator, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
