...
/**
 * affectedArea_cancelHidden_singleAllocatable_byHidden.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "affectedArea_cancelHidden_singleAllocatable_byHidden.hpp"
...
affectedArea_cancelHidden_singleAllocatable_byHidden::affectedArea_cancelHidden_singleAllocatable_byHidden(void)
{
}
...
void affectedArea_cancelHidden_singleAllocatable_byHidden::SetUp(void)
{
...
void affectedArea_cancelHidden_singleAllocatable_byHidden::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byHidden, Test_1) {
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byHidden, Test_10) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byHidden, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byHidden, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byHidden, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byHidden, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byHidden, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byHidden, Test_7) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byHidden, Test_8) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelHidden_singleAllocatable_byHidden, Test_9) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
