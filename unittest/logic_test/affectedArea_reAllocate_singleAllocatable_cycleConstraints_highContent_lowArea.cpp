...
/**
 * affectedArea_reAllocate_singleAllocatable_cycleConstraints_highContent_lowArea.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "affectedArea_reAllocate_singleAllocatable_cycleConstraints_highContent_lowArea.hpp"
...
affectedArea_reAllocate_singleAllocatable_cycleConstraints_highContent_lowArea::affectedArea_reAllocate_singleAllocatable_cycleConstraints_highContent_lowArea(void)
{
}
...
void affectedArea_reAllocate_singleAllocatable_cycleConstraints_highContent_lowArea::SetUp(void)
{
...
void affectedArea_reAllocate_singleAllocatable_cycleConstraints_highContent_lowArea::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(affectedArea_reAllocate_singleAllocatable_cycleConstraints_highContent_lowArea, Test_1) {
