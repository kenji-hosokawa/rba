...
/**
 * PreviousModifier_AllocatedContent.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "PreviousModifier_AllocatedContent.hpp"
...
PreviousModifier_AllocatedContent::PreviousModifier_AllocatedContent(void)
{
}
...
void PreviousModifier_AllocatedContent::SetUp(void)
{
...
void PreviousModifier_AllocatedContent::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(PreviousModifier_AllocatedContent, Test_1) {
  ...
  elems = {u8"C",u8"ON",u8"コンテントB2",u8"NORMAL"};
  {
    std::string kind = elems[1];
    std::string cont = elems[2];
    std::string state = elems[3];
  ...
  elems = {u8"C",u8"ON",u8"コンテントC2",u8"NORMAL"};
  {
    std::string kind = elems[1];
    std::string cont = elems[2];
    std::string state = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"エリアC",u8"コンテントC2"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
  ...
  elems = {u8"C",u8"ON",u8"コンテントB1",u8"NORMAL"};
  {
    std::string kind = elems[1];
    std::string cont = elems[2];
    std::string state = elems[3];
