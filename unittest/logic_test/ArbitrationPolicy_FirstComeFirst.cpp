...
/**
 * ArbitrationPolicy_FirstComeFirst.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "ArbitrationPolicy_FirstComeFirst.hpp"
...
ArbitrationPolicy_FirstComeFirst::ArbitrationPolicy_FirstComeFirst(void)
{
}
...
void ArbitrationPolicy_FirstComeFirst::SetUp(void)
{
...
void ArbitrationPolicy_FirstComeFirst::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(ArbitrationPolicy_FirstComeFirst, Test_basic) {
