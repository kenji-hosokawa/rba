...
OutputtingSound::OutputtingSound(void)
{
}
...
void OutputtingSound::SetUp(void)
{
...
void OutputtingSound::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(OutputtingSound, Test_get) {
...
TEST_F(OutputtingSound, Test_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
