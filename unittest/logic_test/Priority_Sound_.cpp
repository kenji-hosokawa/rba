...
Priority_Sound_::Priority_Sound_(void)
{
}
...
void Priority_Sound_::SetUp(void)
{
...
void Priority_Sound_::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Priority_Sound_, Test_test) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;

  elems = {u8"C",u8"ON",u8"Content1",u8"NORMAL"};
  {
  ...
  elems = {u8"C",u8"ON",u8"Content2",u8"NORMAL"};
  {
    std::string kind = elems[1];
    std::string cont = elems[2];
    std::string state = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"A",u8"Content2"};
  {
    std::string kind = elems[1];
  ...
  elems = {u8"Assert",u8"A",u8"B",u8"Content1"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
