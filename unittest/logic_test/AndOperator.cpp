...
void AndOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(AndOperator, Test_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
