...
#include "HA763_ReArbitration_33.hpp"

namespace {

using namespace rba;

HA763_ReArbitration_33::HA763_ReArbitration_33() {}
HA763_ReArbitration_33::~HA763_ReArbitration_33() {}

void HA763_ReArbitration_33::SetUp()
{
...
void HA763_ReArbitration_33::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA763_ReArbitration_33::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA763_ReArbitration_33::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA763_ReArbitration_33::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA763_ReArbitration_33::getAllocated(const std::string& msg,
...
bool HA763_ReArbitration_33::isCanceled(const std::string& msg,
...
bool HA763_ReArbitration_33::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA763_ReArbitration_33::getProperty(const std::string& msg,
...
bool HA763_ReArbitration_33::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA763_ReArbitration_33::isEnableContext(const std::string& msg,
...
bool HA763_ReArbitration_33::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA763_ReArbitration_33::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA763_ReArbitration_33, Test_01)
{
