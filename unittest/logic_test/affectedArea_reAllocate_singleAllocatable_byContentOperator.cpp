...
/**
 * affectedArea_reAllocate_singleAllocatable_byContentOperator.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "affectedArea_reAllocate_singleAllocatable_byContentOperator.hpp"
...
affectedArea_reAllocate_singleAllocatable_byContentOperator::affectedArea_reAllocate_singleAllocatable_byContentOperator(void)
{
}
...
void affectedArea_reAllocate_singleAllocatable_byContentOperator::SetUp(void)
{
...
void affectedArea_reAllocate_singleAllocatable_byContentOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(affectedArea_reAllocate_singleAllocatable_byContentOperator, Test_5) {
...
TEST_F(affectedArea_reAllocate_singleAllocatable_byContentOperator, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_reAllocate_singleAllocatable_byContentOperator, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_reAllocate_singleAllocatable_byContentOperator, Test_7) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_reAllocate_singleAllocatable_byContentOperator, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_reAllocate_singleAllocatable_byContentOperator, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_reAllocate_singleAllocatable_byContentOperator, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
