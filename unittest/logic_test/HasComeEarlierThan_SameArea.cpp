...
/**
 * HasComeEarlierThan_SameArea.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HasComeEarlierThan_SameArea.hpp"
...
HasComeEarlierThan_SameArea::HasComeEarlierThan_SameArea(void)
{
}
...
void HasComeEarlierThan_SameArea::SetUp(void)
{
...
void HasComeEarlierThan_SameArea::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HasComeEarlierThan_SameArea, Test_TwoRequests1) {
...
TEST_F(HasComeEarlierThan_SameArea, Test_TwoRequests2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeEarlierThan_SameArea, Test_TwoRequests3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeEarlierThan_SameArea, Test_OneRequest2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeEarlierThan_SameArea, Test_OneRequest1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
