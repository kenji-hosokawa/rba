/**
 * Implies_OR_Area_Middle_or_LowToHigh.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_OR_Area_Middle_or_LowToHigh.hpp"
...
Implies_OR_Area_Middle_or_LowToHigh::Implies_OR_Area_Middle_or_LowToHigh(void)
{
}
...
void Implies_OR_Area_Middle_or_LowToHigh::SetUp(void)
{
...
void Implies_OR_Area_Middle_or_LowToHigh::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_OR_Area_Middle_or_LowToHigh, Test_1) {
...
TEST_F(Implies_OR_Area_Middle_or_LowToHigh, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_Middle_or_LowToHigh, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_Middle_or_LowToHigh, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_Middle_or_LowToHigh, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_Middle_or_LowToHigh, Test_ReadMe) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;


}
TEST_F(Implies_OR_Area_Middle_or_LowToHigh, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
