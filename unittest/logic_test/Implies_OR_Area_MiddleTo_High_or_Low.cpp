/**
 * Implies_OR_Area_MiddleTo_High_or_Low.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_OR_Area_MiddleTo_High_or_Low.hpp"
...
Implies_OR_Area_MiddleTo_High_or_Low::Implies_OR_Area_MiddleTo_High_or_Low(void)
{
}
...
void Implies_OR_Area_MiddleTo_High_or_Low::SetUp(void)
{
...
void Implies_OR_Area_MiddleTo_High_or_Low::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_OR_Area_MiddleTo_High_or_Low, Test_1) {
...
TEST_F(Implies_OR_Area_MiddleTo_High_or_Low, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_MiddleTo_High_or_Low, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_MiddleTo_High_or_Low, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_MiddleTo_High_or_Low, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_MiddleTo_High_or_Low, Test_ReadMe) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;


}
TEST_F(Implies_OR_Area_MiddleTo_High_or_Low, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
