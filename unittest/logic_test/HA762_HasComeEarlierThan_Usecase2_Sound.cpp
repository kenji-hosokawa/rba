...
/**
 * HA762_HasComeEarlierThan_Usecase2_Sound.cpp
 */
...
#include "HA762_HasComeEarlierThan_Usecase2_Sound.hpp"

namespace {

using namespace rba;

HA762_HasComeEarlierThan_Usecase2_Sound::HA762_HasComeEarlierThan_Usecase2_Sound() {}
HA762_HasComeEarlierThan_Usecase2_Sound::~HA762_HasComeEarlierThan_Usecase2_Sound() {}

void HA762_HasComeEarlierThan_Usecase2_Sound::SetUp()
{
...
void HA762_HasComeEarlierThan_Usecase2_Sound::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_HasComeEarlierThan_Usecase2_Sound::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_HasComeEarlierThan_Usecase2_Sound::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_HasComeEarlierThan_Usecase2_Sound::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_HasComeEarlierThan_Usecase2_Sound::getAllocated(const std::string& msg,
...
bool HA762_HasComeEarlierThan_Usecase2_Sound::isCanceled(const std::string& msg,
...
bool HA762_HasComeEarlierThan_Usecase2_Sound::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_HasComeEarlierThan_Usecase2_Sound::getProperty(const std::string& msg,
...
bool HA762_HasComeEarlierThan_Usecase2_Sound::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_HasComeEarlierThan_Usecase2_Sound::isEnableContext(const std::string& msg,
...
bool HA762_HasComeEarlierThan_Usecase2_Sound::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_HasComeEarlierThan_Usecase2_Sound::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_HasComeEarlierThan_Usecase2_Sound, Test_01)
{
...
// 0009  #start 2
TEST_F(HA762_HasComeEarlierThan_Usecase2_Sound, Test_02)
{
  std::list<std::string> contexts;
...
// 0017  #start 3
TEST_F(HA762_HasComeEarlierThan_Usecase2_Sound, Test_03)
{
  std::list<std::string> contexts;
...
// 0026  #start 4
TEST_F(HA762_HasComeEarlierThan_Usecase2_Sound, Test_04)
{
  std::list<std::string> contexts;
