...
HA762_HasComeEarlierThan_SameZone2::HA762_HasComeEarlierThan_SameZone2() {}
HA762_HasComeEarlierThan_SameZone2::~HA762_HasComeEarlierThan_SameZone2() {}

void HA762_HasComeEarlierThan_SameZone2::SetUp()
{
...
void HA762_HasComeEarlierThan_SameZone2::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_HasComeEarlierThan_SameZone2::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_HasComeEarlierThan_SameZone2::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_HasComeEarlierThan_SameZone2::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_HasComeEarlierThan_SameZone2::getAllocated(const std::string& msg,
...
bool HA762_HasComeEarlierThan_SameZone2::isCanceled(const std::string& msg,
...
bool HA762_HasComeEarlierThan_SameZone2::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_HasComeEarlierThan_SameZone2::getProperty(const std::string& msg,
...
bool HA762_HasComeEarlierThan_SameZone2::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_HasComeEarlierThan_SameZone2::isEnableContext(const std::string& msg,
...
bool HA762_HasComeEarlierThan_SameZone2::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_HasComeEarlierThan_SameZone2::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_HasComeEarlierThan_SameZone2, Test_01)
{
...
// 0013  #start 2
TEST_F(HA762_HasComeEarlierThan_SameZone2, Test_02)
{
  std::list<std::string> contexts;
...
// 0043  #start 3
TEST_F(HA762_HasComeEarlierThan_SameZone2, Test_03)
{
  std::list<std::string> contexts;
