...
/**
 * IsLowerThanEqualOperator.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "IsLowerThanEqualOperator.hpp"
...
IsLowerThanEqualOperator::IsLowerThanEqualOperator(void)
{
}
...
void IsLowerThanEqualOperator::SetUp(void)
{
...
void IsLowerThanEqualOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(IsLowerThanEqualOperator, Test_true) {
...
TEST_F(IsLowerThanEqualOperator, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
