...
/**
 * HA762_SetOfOperator_ContentSet_allocatable_add.hpp
 */

#ifndef HA762_SETOFOPERATOR_CONTENTSET_ALLOCATABLE_ADD_HPP
#define HA762_SETOFOPERATOR_CONTENTSET_ALLOCATABLE_ADD_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_SetOfOperator_ContentSet_allocatable_add.json"

namespace {

using namespace rba;

class HA762_SetOfOperator_ContentSet_allocatable_add : public ::testing::Test
{
protected:
  HA762_SetOfOperator_ContentSet_allocatable_add();
  virtual ~HA762_SetOfOperator_ContentSet_allocatable_add();
  virtual void SetUp();
