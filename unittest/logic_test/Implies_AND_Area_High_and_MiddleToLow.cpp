...
/**
 * Implies_AND_Area_High_and_MiddleToLow.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_AND_Area_High_and_MiddleToLow.hpp"
...
Implies_AND_Area_High_and_MiddleToLow::Implies_AND_Area_High_and_MiddleToLow(void)
{
}
...
void Implies_AND_Area_High_and_MiddleToLow::SetUp(void)
{
...
void Implies_AND_Area_High_and_MiddleToLow::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_AND_Area_High_and_MiddleToLow, Test_5) {
...
TEST_F(Implies_AND_Area_High_and_MiddleToLow, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_High_and_MiddleToLow, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_High_and_MiddleToLow, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_High_and_MiddleToLow, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_High_and_MiddleToLow, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
