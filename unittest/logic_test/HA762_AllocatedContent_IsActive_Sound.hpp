...
/**
 * HA762_AllocatedContent_IsActive_Sound.hpp
 */

#ifndef HA762_ALLOCATEDCONTENT_ISACTIVE_SOUND_HPP
#define HA762_ALLOCATEDCONTENT_ISACTIVE_SOUND_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_AllocatedContent_IsActive_Sound.json"

namespace {

using namespace rba;

class HA762_AllocatedContent_IsActive_Sound : public ::testing::Test
{
protected:
  HA762_AllocatedContent_IsActive_Sound();
  virtual ~HA762_AllocatedContent_IsActive_Sound();
  virtual void SetUp();
