...
#include "HA763_ReArbitration_79.hpp"

namespace {

using namespace rba;

HA763_ReArbitration_79::HA763_ReArbitration_79() {}
HA763_ReArbitration_79::~HA763_ReArbitration_79() {}

void HA763_ReArbitration_79::SetUp()
{
...
void HA763_ReArbitration_79::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA763_ReArbitration_79::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA763_ReArbitration_79::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA763_ReArbitration_79::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA763_ReArbitration_79::getAllocated(const std::string& msg,
...
bool HA763_ReArbitration_79::isCanceled(const std::string& msg,
...
bool HA763_ReArbitration_79::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA763_ReArbitration_79::getProperty(const std::string& msg,
...
bool HA763_ReArbitration_79::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA763_ReArbitration_79::isEnableContext(const std::string& msg,
...
bool HA763_ReArbitration_79::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA763_ReArbitration_79::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA763_ReArbitration_79, Test_01)
{
...
// 0012  #start 2
TEST_F(HA763_ReArbitration_79, Test_02)
{
  std::list<std::string> contexts;
