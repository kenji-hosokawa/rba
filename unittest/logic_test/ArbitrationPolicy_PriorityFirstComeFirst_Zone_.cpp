...
/**
 * ArbitrationPolicy_PriorityFirstComeFirst_Zone_.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "ArbitrationPolicy_PriorityFirstComeFirst_Zone_.hpp"
...
ArbitrationPolicy_PriorityFirstComeFirst_Zone_::ArbitrationPolicy_PriorityFirstComeFirst_Zone_(void)
{
}
...
void ArbitrationPolicy_PriorityFirstComeFirst_Zone_::SetUp(void)
{
...
void ArbitrationPolicy_PriorityFirstComeFirst_Zone_::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(ArbitrationPolicy_PriorityFirstComeFirst_Zone_, Test_basic) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;

  elems = {u8"C",u8"ON",u8"C1",u8"CS_N"};
  {
  ...
  elems = {u8"Assert",u8"A",u8"A1",u8"C1"};
  {
    std::string kind = elems[1];
  ...
  elems = {u8"C",u8"ON",u8"C2",u8"CS_N"};
  {
    std::string kind = elems[1];
    std::string cont = elems[2];
    std::string state = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"A1",u8"C2"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
  ...
  elems = {u8"C",u8"ON",u8"C3",u8"CS_N"};
  {
    std::string kind = elems[1];
    std::string cont = elems[2];
    std::string state = elems[3];
  ...
  elems = {u8"C",u8"OFF",u8"C2",u8"CS_N"};
  {
    std::string kind = elems[1];
    std::string cont = elems[2];
    std::string state = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"A1",u8"C3"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
