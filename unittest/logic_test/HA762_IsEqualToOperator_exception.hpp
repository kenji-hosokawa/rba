...
/**
 * HA762_IsEqualToOperator_exception.hpp
 */

#ifndef HA762_ISEQUALTOOPERATOR_EXCEPTION_HPP
#define HA762_ISEQUALTOOPERATOR_EXCEPTION_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_IsEqualToOperator_exception.json"

namespace {

using namespace rba;

class HA762_IsEqualToOperator_exception : public ::testing::Test
{
protected:
  HA762_IsEqualToOperator_exception();
  virtual ~HA762_IsEqualToOperator_exception();
  virtual void SetUp();
