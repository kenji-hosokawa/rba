...
/**
 * HA762_IsLowerThanOperator_exception.hpp
 */

#ifndef HA762_ISLOWERTHANOPERATOR_EXCEPTION_HPP
#define HA762_ISLOWERTHANOPERATOR_EXCEPTION_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_IsLowerThanOperator_exception.json"

namespace {

using namespace rba;

class HA762_IsLowerThanOperator_exception : public ::testing::Test
{
protected:
  HA762_IsLowerThanOperator_exception();
  virtual ~HA762_IsLowerThanOperator_exception();
  virtual void SetUp();
