...
IsHidden_Chain::IsHidden_Chain(void)
{
}
...
void IsHidden_Chain::SetUp(void)
{
...
void IsHidden_Chain::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(IsHidden_Chain, Test_rearbitration_lowArea_hidden_middleArea) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;

  elems = {u8"C",u8"ON",u8"コンテンツF1",u8"NORMAL"};
  {
  ...
  elems = {u8"C",u8"ON",u8"コンテンツE1",u8"NORMAL"};
  {
    std::string kind = elems[1];
    std::string cont = elems[2];
    std::string state = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"エリアD",u8"NULL"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"エリアE",u8"NULL"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"エリアF",u8"コンテンツF1"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
...
TEST_F(IsHidden_Chain, Test_highArea_hidden_middleArea_hidden_lowArea) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
  ...
  elems = {u8"Assert",u8"A",u8"エリアF",u8"NULL"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
...
TEST_F(IsHidden_Chain, Test_rearbitration_lowArea_hidden_middleArea_hidden_highArea) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
  ...
  elems = {u8"C",u8"ON",u8"コンテンツD2",u8"NORMAL"};
  {
    std::string kind = elems[1];
    std::string cont = elems[2];
    std::string state = elems[3];
...
TEST_F(IsHidden_Chain, Test_rearbitration_middleArea_hidden_highArea) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
  ...
  elems = {u8"Assert",u8"A",u8"エリアE",u8"コンテンツE1"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
...
TEST_F(IsHidden_Chain, Test_highArea_hidden_middleArea) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IsHidden_Chain, Test_middleArea_hidden_lowArea) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
