...
/**
 * HasComeLaterThan_Usecase.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HasComeLaterThan_Usecase.hpp"
...
HasComeLaterThan_Usecase::HasComeLaterThan_Usecase(void)
{
}
...
void HasComeLaterThan_Usecase::SetUp(void)
{
...
void HasComeLaterThan_Usecase::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HasComeLaterThan_Usecase, Test_TwoRequests1) {
...
TEST_F(HasComeLaterThan_Usecase, Test_TwoRequests2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeLaterThan_Usecase, Test_OneRequest2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeLaterThan_Usecase, Test_OneRequest1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
