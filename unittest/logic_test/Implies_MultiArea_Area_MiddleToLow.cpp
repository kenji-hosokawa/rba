...
/**
 * Implies_MultiArea_Area_MiddleToLow.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_MultiArea_Area_MiddleToLow.hpp"
...
Implies_MultiArea_Area_MiddleToLow::Implies_MultiArea_Area_MiddleToLow(void)
{
}
...
void Implies_MultiArea_Area_MiddleToLow::SetUp(void)
{
...
void Implies_MultiArea_Area_MiddleToLow::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_MultiArea_Area_MiddleToLow, Test_4) {
...
TEST_F(Implies_MultiArea_Area_MiddleToLow, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MultiArea_Area_MiddleToLow, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MultiArea_Area_MiddleToLow, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
