...
/**
 * Implies_Chain_Area_LowToMiddleToHigh.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_Chain_Area_LowToMiddleToHigh.hpp"
...
Implies_Chain_Area_LowToMiddleToHigh::Implies_Chain_Area_LowToMiddleToHigh(void)
{
}
...
void Implies_Chain_Area_LowToMiddleToHigh::SetUp(void)
{
...
void Implies_Chain_Area_LowToMiddleToHigh::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_Chain_Area_LowToMiddleToHigh, Test_5) {
...
TEST_F(Implies_Chain_Area_LowToMiddleToHigh, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_LowToMiddleToHigh, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_LowToMiddleToHigh, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_LowToMiddleToHigh, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_LowToMiddleToHigh, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
