...
#include "HA762_state.hpp"

namespace {

using namespace rba;

HA762_state::HA762_state() {}
HA762_state::~HA762_state() {}

void HA762_state::SetUp()
{
...
bool HA762_state::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_state::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_state::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_state::getAllocated(const std::string& msg,
...
bool HA762_state::isCanceled(const std::string& msg,
...
bool HA762_state::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_state::getProperty(const std::string& msg,
...
bool HA762_state::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_state::isEnableContext(const std::string& msg,
...
bool HA762_state::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_state::isAttenuated(const std::string& msg,
