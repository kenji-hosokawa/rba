...
/**
 * Implies_OR_Area_LowTo_High_or_Middle.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_OR_Area_LowTo_High_or_Middle.hpp"
...
Implies_OR_Area_LowTo_High_or_Middle::Implies_OR_Area_LowTo_High_or_Middle(void)
{
}
...
void Implies_OR_Area_LowTo_High_or_Middle::SetUp(void)
{
...
void Implies_OR_Area_LowTo_High_or_Middle::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_OR_Area_LowTo_High_or_Middle, Test_5) {
...
TEST_F(Implies_OR_Area_LowTo_High_or_Middle, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_LowTo_High_or_Middle, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_LowTo_High_or_Middle, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_LowTo_High_or_Middle, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_LowTo_High_or_Middle, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
