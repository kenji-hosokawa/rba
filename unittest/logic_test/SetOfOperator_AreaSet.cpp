...
/**
 * SetOfOperator_AreaSet.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "SetOfOperator_AreaSet.hpp"
...
SetOfOperator_AreaSet::SetOfOperator_AreaSet(void)
{
}
...
void SetOfOperator_AreaSet::SetUp(void)
{
...
void SetOfOperator_AreaSet::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(SetOfOperator_AreaSet, Test_test) {
