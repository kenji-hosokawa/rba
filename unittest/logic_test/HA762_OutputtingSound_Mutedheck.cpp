...
/**
 * HA762_OutputtingSound_Mutedheck.cpp
 */
...
#include "HA762_OutputtingSound_Mutedheck.hpp"

namespace {

using namespace rba;

HA762_OutputtingSound_Mutedheck::HA762_OutputtingSound_Mutedheck() {}
HA762_OutputtingSound_Mutedheck::~HA762_OutputtingSound_Mutedheck() {}

void HA762_OutputtingSound_Mutedheck::SetUp()
{
...
void HA762_OutputtingSound_Mutedheck::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_OutputtingSound_Mutedheck::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_OutputtingSound_Mutedheck::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_OutputtingSound_Mutedheck::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_OutputtingSound_Mutedheck::getAllocated(const std::string& msg,
...
bool HA762_OutputtingSound_Mutedheck::isCanceled(const std::string& msg,
...
bool HA762_OutputtingSound_Mutedheck::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_OutputtingSound_Mutedheck::getProperty(const std::string& msg,
...
bool HA762_OutputtingSound_Mutedheck::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_OutputtingSound_Mutedheck::isEnableContext(const std::string& msg,
...
bool HA762_OutputtingSound_Mutedheck::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_OutputtingSound_Mutedheck::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_OutputtingSound_Mutedheck, Test_01)
{
  ...
  // 0026  Assert,A,C,c1,attenuated:false
  EXPECT_EQ(u8"c1",getAllocated("line=26", u8"C"));
  EXPECT_FALSE(isAttenuated("line=26", u8"C"));
