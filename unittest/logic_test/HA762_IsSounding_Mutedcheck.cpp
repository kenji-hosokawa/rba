...
/**
 * HA762_IsSounding_Mutedcheck.cpp
 */
...
#include "HA762_IsSounding_Mutedcheck.hpp"

namespace {

using namespace rba;

HA762_IsSounding_Mutedcheck::HA762_IsSounding_Mutedcheck() {}
HA762_IsSounding_Mutedcheck::~HA762_IsSounding_Mutedcheck() {}

void HA762_IsSounding_Mutedcheck::SetUp()
{
...
void HA762_IsSounding_Mutedcheck::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_IsSounding_Mutedcheck::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_IsSounding_Mutedcheck::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_IsSounding_Mutedcheck::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_IsSounding_Mutedcheck::getAllocated(const std::string& msg,
...
bool HA762_IsSounding_Mutedcheck::isCanceled(const std::string& msg,
...
bool HA762_IsSounding_Mutedcheck::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_IsSounding_Mutedcheck::getProperty(const std::string& msg,
...
bool HA762_IsSounding_Mutedcheck::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_IsSounding_Mutedcheck::isEnableContext(const std::string& msg,
...
bool HA762_IsSounding_Mutedcheck::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_IsSounding_Mutedcheck::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_IsSounding_Mutedcheck, Test_01)
{
  ...
  // 0007  Assert,A,B,,attenuated:false
  EXPECT_EQ(u8"",getAllocated("line=7", u8"B"));
  // 0008  Assert,A,C,c1,attenuated:false
  EXPECT_EQ(u8"c1",getAllocated("line=8", u8"C"));
  EXPECT_FALSE(isAttenuated("line=8", u8"C"));
