...
/**
 * GetAllocatables_Set.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "GetAllocatables_Set.hpp"
...
GetAllocatables_Set::GetAllocatables_Set(void)
{
}
...
void GetAllocatables_Set::SetUp(void)
{
...
void GetAllocatables_Set::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(GetAllocatables_Set, Test_1) {
...
TEST_F(GetAllocatables_Set, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
