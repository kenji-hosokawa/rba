...
/**
 * HA762_ForAllOperator_exception.hpp
 */

#ifndef HA762_FORALLOPERATOR_EXCEPTION_HPP
#define HA762_FORALLOPERATOR_EXCEPTION_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_ForAllOperator_exception.json"

namespace {

using namespace rba;

class HA762_ForAllOperator_exception : public ::testing::Test
{
protected:
  HA762_ForAllOperator_exception();
  virtual ~HA762_ForAllOperator_exception();
  virtual void SetUp();
