...
/**
 * SetOfOperator_SoundContentSet_SoundContent.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "SetOfOperator_SoundContentSet_SoundContent.hpp"
...
SetOfOperator_SoundContentSet_SoundContent::SetOfOperator_SoundContentSet_SoundContent(void)
{
}
...
void SetOfOperator_SoundContentSet_SoundContent::SetUp(void)
{
...
void SetOfOperator_SoundContentSet_SoundContent::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(SetOfOperator_SoundContentSet_SoundContent, Test_test) {
  ...
  elems = {u8"Assert",u8"A",u8"AllocatableC",u8"NULL"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
