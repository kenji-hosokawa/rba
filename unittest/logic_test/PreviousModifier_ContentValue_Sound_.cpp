...
/**
 * PreviousModifier_ContentValue_Sound_.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "PreviousModifier_ContentValue_Sound_.hpp"
...
PreviousModifier_ContentValue_Sound_::PreviousModifier_ContentValue_Sound_(void)
{
}
...
void PreviousModifier_ContentValue_Sound_::SetUp(void)
{
...
void PreviousModifier_ContentValue_Sound_::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(PreviousModifier_ContentValue_Sound_, Test_1) {
  ...
  elems = {u8"Assert",u8"A",u8"AllocatableA",u8"NULL"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
