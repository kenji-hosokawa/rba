...
/**
 * HA762_OutputtingSound_Mutedheck.hpp
 */

#ifndef HA762_OUTPUTTINGSOUND_MUTEDHECK_HPP
#define HA762_OUTPUTTINGSOUND_MUTEDHECK_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_OutputtingSound_Mutedheck.json"

namespace {

using namespace rba;

class HA762_OutputtingSound_Mutedheck : public ::testing::Test
{
protected:
  HA762_OutputtingSound_Mutedheck();
  virtual ~HA762_OutputtingSound_Mutedheck();
  virtual void SetUp();
