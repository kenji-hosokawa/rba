...
/**
 * SetOfOperator_Content.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "SetOfOperator_Content.hpp"
...
SetOfOperator_Content::SetOfOperator_Content(void)
{
}
...
void SetOfOperator_Content::SetUp(void)
{
...
void SetOfOperator_Content::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(SetOfOperator_Content, Test_true) {
...
TEST_F(SetOfOperator_Content, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(SetOfOperator_Content, Test_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
