...
/**
 * ImpliesOperator_IfStatement_Exists.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "ImpliesOperator_IfStatement_Exists.hpp"
...
ImpliesOperator_IfStatement_Exists::ImpliesOperator_IfStatement_Exists(void)
{
}
...
void ImpliesOperator_IfStatement_Exists::SetUp(void)
{
...
void ImpliesOperator_IfStatement_Exists::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(ImpliesOperator_IfStatement_Exists, Test_8) {
...
TEST_F(ImpliesOperator_IfStatement_Exists, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ImpliesOperator_IfStatement_Exists, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ImpliesOperator_IfStatement_Exists, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ImpliesOperator_IfStatement_Exists, Test_7) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ImpliesOperator_IfStatement_Exists, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ImpliesOperator_IfStatement_Exists, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ImpliesOperator_IfStatement_Exists, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
