...
/**
 * HA762_DisplayingContent_Hiddencheck.cpp
 */
...
#include "HA762_DisplayingContent_Hiddencheck.hpp"

namespace {

using namespace rba;

HA762_DisplayingContent_Hiddencheck::HA762_DisplayingContent_Hiddencheck() {}
HA762_DisplayingContent_Hiddencheck::~HA762_DisplayingContent_Hiddencheck() {}

void HA762_DisplayingContent_Hiddencheck::SetUp()
{
...
void HA762_DisplayingContent_Hiddencheck::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_DisplayingContent_Hiddencheck::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_DisplayingContent_Hiddencheck::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_DisplayingContent_Hiddencheck::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_DisplayingContent_Hiddencheck::getAllocated(const std::string& msg,
...
bool HA762_DisplayingContent_Hiddencheck::isCanceled(const std::string& msg,
...
bool HA762_DisplayingContent_Hiddencheck::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_DisplayingContent_Hiddencheck::getProperty(const std::string& msg,
...
bool HA762_DisplayingContent_Hiddencheck::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_DisplayingContent_Hiddencheck::isEnableContext(const std::string& msg,
...
bool HA762_DisplayingContent_Hiddencheck::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_DisplayingContent_Hiddencheck::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_DisplayingContent_Hiddencheck, Test_01)
{
