...
/**
 * HA762_HasComeEarlierThan_SameContent_Sound.hpp
 */

#ifndef HA762_HASCOMEEARLIERTHAN_SAMECONTENT_SOUND_HPP
#define HA762_HASCOMEEARLIERTHAN_SAMECONTENT_SOUND_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_HasComeEarlierThan_SameContent_Sound.json"

namespace {

using namespace rba;

class HA762_HasComeEarlierThan_SameContent_Sound : public ::testing::Test
{
protected:
  HA762_HasComeEarlierThan_SameContent_Sound();
  virtual ~HA762_HasComeEarlierThan_SameContent_Sound();
  virtual void SetUp();
