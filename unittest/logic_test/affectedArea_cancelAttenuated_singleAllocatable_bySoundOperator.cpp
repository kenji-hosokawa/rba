...
/**
 * affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator.hpp"
...
affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator::affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator(void)
{
}
...
void affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator::SetUp(void)
{
...
void affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator, Test_12) {
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator, Test_10) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator, Test_11) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator, Test_9) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator, Test_8) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator, Test_7) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(affectedArea_cancelAttenuated_singleAllocatable_bySoundOperator, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
