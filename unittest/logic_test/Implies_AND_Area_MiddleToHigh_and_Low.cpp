...
/**
 * Implies_AND_Area_MiddleToHigh_and_Low.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_AND_Area_MiddleToHigh_and_Low.hpp"
...
Implies_AND_Area_MiddleToHigh_and_Low::Implies_AND_Area_MiddleToHigh_and_Low(void)
{
}
...
void Implies_AND_Area_MiddleToHigh_and_Low::SetUp(void)
{
...
void Implies_AND_Area_MiddleToHigh_and_Low::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_AND_Area_MiddleToHigh_and_Low, Test_5) {
...
TEST_F(Implies_AND_Area_MiddleToHigh_and_Low, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_MiddleToHigh_and_Low, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_MiddleToHigh_and_Low, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_MiddleToHigh_and_Low, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_MiddleToHigh_and_Low, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
