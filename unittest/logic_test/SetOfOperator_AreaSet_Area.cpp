...
/**
 * SetOfOperator_AreaSet_Area.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "SetOfOperator_AreaSet_Area.hpp"
...
SetOfOperator_AreaSet_Area::SetOfOperator_AreaSet_Area(void)
{
}
...
void SetOfOperator_AreaSet_Area::SetUp(void)
{
...
void SetOfOperator_AreaSet_Area::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(SetOfOperator_AreaSet_Area, Test_test) {
