...
/**
 * Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_.hpp"
...
Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_::Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_(void)
{
}
...
void Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_::SetUp(void)
{
...
void Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_, Test_12) {
...
TEST_F(Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_, Test_10) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_, Test_11) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_, Test_9) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_, Test_8) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
  ...
  elems = {u8"Assert",u8"A",u8"エリアC",u8"コンテンツC2"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
...
TEST_F(Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_, Test_7) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_High_Area_ToLow_Content_ToMiddle_Content_, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
