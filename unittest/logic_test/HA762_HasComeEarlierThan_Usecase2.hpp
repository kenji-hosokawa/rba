...
/**
 * HA762_HasComeEarlierThan_Usecase2.hpp
 */

#ifndef HA762_HASCOMEEARLIERTHAN_USECASE2_HPP
#define HA762_HASCOMEEARLIERTHAN_USECASE2_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_HasComeEarlierThan_Usecase2.json"

namespace {

using namespace rba;

class HA762_HasComeEarlierThan_Usecase2 : public ::testing::Test
{
protected:
  HA762_HasComeEarlierThan_Usecase2();
  virtual ~HA762_HasComeEarlierThan_Usecase2();
  virtual void SetUp();
