...
/**
 * ImpliesOperator_For_All_IfStatement.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "ImpliesOperator_For_All_IfStatement.hpp"
...
ImpliesOperator_For_All_IfStatement::ImpliesOperator_For_All_IfStatement(void)
{
}
...
void ImpliesOperator_For_All_IfStatement::SetUp(void)
{
...
void ImpliesOperator_For_All_IfStatement::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(ImpliesOperator_For_All_IfStatement, Test_8) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;

  elems = {u8"S",u8"ON",u8"シーンX"};
  {
...
TEST_F(ImpliesOperator_For_All_IfStatement, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ImpliesOperator_For_All_IfStatement, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;

  elems = {u8"S",u8"OFF",u8"シーンX"};
  {
    ASSERT_EQ(3u, elems.size());
    ASSERT_STRNE("", elems[0].c_str());
    ASSERT_STRNE("", elems[1].c_str());
    ...
    std::string kind = elems[1];
    std::string scene = elems[2];
    result = arb->execute(scene.c_str(), false); // OFF
    EXPECT_EQ(rba::RBAResultStatusType::SUCCESS, result->getStatusType());
  }
...
TEST_F(ImpliesOperator_For_All_IfStatement, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ImpliesOperator_For_All_IfStatement, Test_7) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ImpliesOperator_For_All_IfStatement, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ImpliesOperator_For_All_IfStatement, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ImpliesOperator_For_All_IfStatement, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
