...
/**
 * HA762_IsGreaterThanOperator_exception.hpp
 */

#ifndef HA762_ISGREATERTHANOPERATOR_EXCEPTION_HPP
#define HA762_ISGREATERTHANOPERATOR_EXCEPTION_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_IsGreaterThanOperator_exception.json"

namespace {

using namespace rba;

class HA762_IsGreaterThanOperator_exception : public ::testing::Test
{
protected:
  HA762_IsGreaterThanOperator_exception();
  virtual ~HA762_IsGreaterThanOperator_exception();
  virtual void SetUp();
