...
/**
 * HA762_IsVisible_Hiddencheck.cpp
 */
...
#include "HA762_IsVisible_Hiddencheck.hpp"

namespace {

using namespace rba;

HA762_IsVisible_Hiddencheck::HA762_IsVisible_Hiddencheck() {}
HA762_IsVisible_Hiddencheck::~HA762_IsVisible_Hiddencheck() {}

void HA762_IsVisible_Hiddencheck::SetUp()
{
...
void HA762_IsVisible_Hiddencheck::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_IsVisible_Hiddencheck::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_IsVisible_Hiddencheck::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_IsVisible_Hiddencheck::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_IsVisible_Hiddencheck::getAllocated(const std::string& msg,
...
bool HA762_IsVisible_Hiddencheck::isCanceled(const std::string& msg,
...
bool HA762_IsVisible_Hiddencheck::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_IsVisible_Hiddencheck::getProperty(const std::string& msg,
...
bool HA762_IsVisible_Hiddencheck::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_IsVisible_Hiddencheck::isEnableContext(const std::string& msg,
...
bool HA762_IsVisible_Hiddencheck::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_IsVisible_Hiddencheck::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_IsVisible_Hiddencheck, Test_01)
{
