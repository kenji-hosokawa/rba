...
/**
 * HA762_HasComeEarlierThan_SameContent.hpp
 */

#ifndef HA762_HASCOMEEARLIERTHAN_SAMECONTENT_HPP
#define HA762_HASCOMEEARLIERTHAN_SAMECONTENT_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_HasComeEarlierThan_SameContent.json"

namespace {

using namespace rba;

class HA762_HasComeEarlierThan_SameContent : public ::testing::Test
{
protected:
  HA762_HasComeEarlierThan_SameContent();
  virtual ~HA762_HasComeEarlierThan_SameContent();
  virtual void SetUp();
