...
/**
 * SetOfOperator_ContentSet_Content.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "SetOfOperator_ContentSet_Content.hpp"
...
SetOfOperator_ContentSet_Content::SetOfOperator_ContentSet_Content(void)
{
}
...
void SetOfOperator_ContentSet_Content::SetUp(void)
{
...
void SetOfOperator_ContentSet_Content::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(SetOfOperator_ContentSet_Content, Test_test) {
