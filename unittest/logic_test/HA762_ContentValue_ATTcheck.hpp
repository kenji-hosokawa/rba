...
/**
 * HA762_ContentValue_ATTcheck.hpp
 */

#ifndef HA762_CONTENTVALUE_ATTCHECK_HPP
#define HA762_CONTENTVALUE_ATTCHECK_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_ContentValue_ATTcheck.json"

namespace {

using namespace rba;

class HA762_ContentValue_ATTcheck : public ::testing::Test
{
protected:
  HA762_ContentValue_ATTcheck();
  virtual ~HA762_ContentValue_ATTcheck();
  virtual void SetUp();
