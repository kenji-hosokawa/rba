...
/**
 * HA762_DisplayingContent_Hiddencheck.hpp
 */

#ifndef HA762_DISPLAYINGCONTENT_HIDDENCHECK_HPP
#define HA762_DISPLAYINGCONTENT_HIDDENCHECK_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_DisplayingContent_Hiddencheck.json"

namespace {

using namespace rba;

class HA762_DisplayingContent_Hiddencheck : public ::testing::Test
{
protected:
  HA762_DisplayingContent_Hiddencheck();
  virtual ~HA762_DisplayingContent_Hiddencheck();
  virtual void SetUp();
