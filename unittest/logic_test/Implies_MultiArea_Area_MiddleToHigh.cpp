...
/**
 * Implies_MultiArea_Area_MiddleToHigh.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_MultiArea_Area_MiddleToHigh.hpp"
...
Implies_MultiArea_Area_MiddleToHigh::Implies_MultiArea_Area_MiddleToHigh(void)
{
}
...
void Implies_MultiArea_Area_MiddleToHigh::SetUp(void)
{
...
void Implies_MultiArea_Area_MiddleToHigh::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_MultiArea_Area_MiddleToHigh, Test_4) {
...
TEST_F(Implies_MultiArea_Area_MiddleToHigh, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MultiArea_Area_MiddleToHigh, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MultiArea_Area_MiddleToHigh, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
