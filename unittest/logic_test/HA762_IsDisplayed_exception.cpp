...
/**
 * HA762_IsDisplayed_exception.cpp
 */
...
#include "HA762_IsDisplayed_exception.hpp"

namespace {

using namespace rba;

HA762_IsDisplayed_exception::HA762_IsDisplayed_exception() {}
HA762_IsDisplayed_exception::~HA762_IsDisplayed_exception() {}

void HA762_IsDisplayed_exception::SetUp()
{
...
void HA762_IsDisplayed_exception::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_IsDisplayed_exception::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_IsDisplayed_exception::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_IsDisplayed_exception::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_IsDisplayed_exception::getAllocated(const std::string& msg,
...
bool HA762_IsDisplayed_exception::isCanceled(const std::string& msg,
...
bool HA762_IsDisplayed_exception::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_IsDisplayed_exception::getProperty(const std::string& msg,
...
bool HA762_IsDisplayed_exception::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_IsDisplayed_exception::isEnableContext(const std::string& msg,
...
bool HA762_IsDisplayed_exception::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_IsDisplayed_exception::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_IsDisplayed_exception, Test_01)
{
