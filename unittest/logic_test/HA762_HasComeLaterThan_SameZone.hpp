...
/**
 * HA762_HasComeLaterThan_SameZone.hpp
 */

#ifndef HA762_HASCOMELATERTHAN_SAMEZONE_HPP
#define HA762_HASCOMELATERTHAN_SAMEZONE_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_HasComeLaterThan_SameZone.json"

namespace {

using namespace rba;

class HA762_HasComeLaterThan_SameZone : public ::testing::Test
{
protected:
  HA762_HasComeLaterThan_SameZone();
  virtual ~HA762_HasComeLaterThan_SameZone();
  virtual void SetUp();
