...
/**
 * HA762_IsDisplayed_Hiddencheck.hpp
 */

#ifndef HA762_ISDISPLAYED_HIDDENCHECK_HPP
#define HA762_ISDISPLAYED_HIDDENCHECK_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_IsDisplayed_Hiddencheck.json"

namespace {

using namespace rba;

class HA762_IsDisplayed_Hiddencheck : public ::testing::Test
{
protected:
  HA762_IsDisplayed_Hiddencheck();
  virtual ~HA762_IsDisplayed_Hiddencheck();
  virtual void SetUp();
