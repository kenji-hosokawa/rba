...
/**
 * AllocatedContent_IsSounding.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "AllocatedContent_IsSounding.hpp"
...
AllocatedContent_IsSounding::AllocatedContent_IsSounding(void)
{
}
...
void AllocatedContent_IsSounding::SetUp(void)
{
...
void AllocatedContent_IsSounding::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(AllocatedContent_IsSounding, Test_exception) {
...
TEST_F(AllocatedContent_IsSounding, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(AllocatedContent_IsSounding, Test_true) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
