...
/**
 * HA762_ContentValue_Hiddencheck.hpp
 */

#ifndef HA762_CONTENTVALUE_HIDDENCHECK_HPP
#define HA762_CONTENTVALUE_HIDDENCHECK_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_ContentValue_Hiddencheck.json"

namespace {

using namespace rba;

class HA762_ContentValue_Hiddencheck : public ::testing::Test
{
protected:
  HA762_ContentValue_Hiddencheck();
  virtual ~HA762_ContentValue_Hiddencheck();
  virtual void SetUp();
