...
/**
 * Implies_Content_HighToLow.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_Content_HighToLow.hpp"
...
Implies_Content_HighToLow::Implies_Content_HighToLow(void)
{
}
...
void Implies_Content_HighToLow::SetUp(void)
{
...
void Implies_Content_HighToLow::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_Content_HighToLow, Test_15) {
...
TEST_F(Implies_Content_HighToLow, Test_14) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_HighToLow, Test_16) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_HighToLow, Test_13) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_HighToLow, Test_12) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_HighToLow, Test_10) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_HighToLow, Test_11) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_HighToLow, Test_9) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_HighToLow, Test_8) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_HighToLow, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_HighToLow, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_HighToLow, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_HighToLow, Test_7) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_HighToLow, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_HighToLow, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_HighToLow, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
