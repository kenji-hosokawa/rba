...
/**
 * PreviousModifier_OutputtingSound.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "PreviousModifier_OutputtingSound.hpp"
...
PreviousModifier_OutputtingSound::PreviousModifier_OutputtingSound(void)
{
}
...
void PreviousModifier_OutputtingSound::SetUp(void)
{
...
void PreviousModifier_OutputtingSound::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(PreviousModifier_OutputtingSound, Test_1) {
