...
/**
 * OutputtingSound_isActive.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "OutputtingSound_isActive.hpp"
...
OutputtingSound_isActive::OutputtingSound_isActive(void)
{
}
...
void OutputtingSound_isActive::SetUp(void)
{
...
void OutputtingSound_isActive::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(OutputtingSound_isActive, Test_execption) {
...
TEST_F(OutputtingSound_isActive, Test_true) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
