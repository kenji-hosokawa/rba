...
#include "HA763_ReArbitration_96.hpp"

namespace {

using namespace rba;

HA763_ReArbitration_96::HA763_ReArbitration_96() {}
HA763_ReArbitration_96::~HA763_ReArbitration_96() {}

void HA763_ReArbitration_96::SetUp()
{
...
void HA763_ReArbitration_96::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA763_ReArbitration_96::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA763_ReArbitration_96::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA763_ReArbitration_96::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA763_ReArbitration_96::getAllocated(const std::string& msg,
...
bool HA763_ReArbitration_96::isCanceled(const std::string& msg,
...
bool HA763_ReArbitration_96::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA763_ReArbitration_96::getProperty(const std::string& msg,
...
bool HA763_ReArbitration_96::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA763_ReArbitration_96::isEnableContext(const std::string& msg,
...
bool HA763_ReArbitration_96::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA763_ReArbitration_96::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA763_ReArbitration_96, Test_01)
{
...
// 0012  #start 2
TEST_F(HA763_ReArbitration_96, Test_02)
{
  std::list<std::string> contexts;
  ...
  // 0017  Assert,A,A,
  EXPECT_EQ(u8"",getAllocated("line=17", u8"A"));
  // 0018  Assert,A,B,B1
  EXPECT_EQ(u8"B1",getAllocated("line=18", u8"B"));
  // 0019  Assert,A,C,
  EXPECT_EQ(u8"",getAllocated("line=19", u8"C"));
  // 0020  Assert,A,D,D1
  EXPECT_EQ(u8"D1",getAllocated("line=20", u8"D"));
}

// 0022  #start 3
TEST_F(HA763_ReArbitration_96, Test_03)
{
  std::list<std::string> contexts;
