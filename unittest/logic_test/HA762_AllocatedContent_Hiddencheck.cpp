...
/**
 * HA762_AllocatedContent_Hiddencheck.cpp
 */
...
#include "HA762_AllocatedContent_Hiddencheck.hpp"

namespace {

using namespace rba;

HA762_AllocatedContent_Hiddencheck::HA762_AllocatedContent_Hiddencheck() {}
HA762_AllocatedContent_Hiddencheck::~HA762_AllocatedContent_Hiddencheck() {}

void HA762_AllocatedContent_Hiddencheck::SetUp()
{
...
void HA762_AllocatedContent_Hiddencheck::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_AllocatedContent_Hiddencheck::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_AllocatedContent_Hiddencheck::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_AllocatedContent_Hiddencheck::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_AllocatedContent_Hiddencheck::getAllocated(const std::string& msg,
...
bool HA762_AllocatedContent_Hiddencheck::isCanceled(const std::string& msg,
...
bool HA762_AllocatedContent_Hiddencheck::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_AllocatedContent_Hiddencheck::getProperty(const std::string& msg,
...
bool HA762_AllocatedContent_Hiddencheck::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_AllocatedContent_Hiddencheck::isEnableContext(const std::string& msg,
...
bool HA762_AllocatedContent_Hiddencheck::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_AllocatedContent_Hiddencheck::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_AllocatedContent_Hiddencheck, Test_01)
{
...
// 0012  #start 2
TEST_F(HA762_AllocatedContent_Hiddencheck, Test_02)
{
  std::list<std::string> contexts;
