...
/**
 * IsLowerThanOperator.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "IsLowerThanOperator.hpp"
...
IsLowerThanOperator::IsLowerThanOperator(void)
{
}
...
void IsLowerThanOperator::SetUp(void)
{
...
void IsLowerThanOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(IsLowerThanOperator, Test_true) {
...
TEST_F(IsLowerThanOperator, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
