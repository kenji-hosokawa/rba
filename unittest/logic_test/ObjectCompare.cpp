...
ObjectCompare::ObjectCompare(void)
{
}
...
void ObjectCompare::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(ObjectCompare, Test_true) {
...
TEST_F(ObjectCompare, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ObjectCompare, Test_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
