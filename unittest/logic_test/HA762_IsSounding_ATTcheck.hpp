...
/**
 * HA762_IsSounding_ATTcheck.hpp
 */

#ifndef HA762_ISSOUNDING_ATTCHECK_HPP
#define HA762_ISSOUNDING_ATTCHECK_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_IsSounding_ATTcheck.json"

namespace {

using namespace rba;

class HA762_IsSounding_ATTcheck : public ::testing::Test
{
protected:
  HA762_IsSounding_ATTcheck();
  virtual ~HA762_IsSounding_ATTcheck();
  virtual void SetUp();
