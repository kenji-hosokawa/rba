...
/**
 * PreviousModifier_IsSounding.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "PreviousModifier_IsSounding.hpp"
...
PreviousModifier_IsSounding::PreviousModifier_IsSounding(void)
{
}
...
void PreviousModifier_IsSounding::SetUp(void)
{
...
void PreviousModifier_IsSounding::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(PreviousModifier_IsSounding, Test_1) {
