...
/**
 * AllInstanceOfZone.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "AllInstanceOfZone.hpp"
...
AllInstanceOfZone::AllInstanceOfZone(void)
{
}
...
void AllInstanceOfZone::SetUp(void)
{
...
void AllInstanceOfZone::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(AllInstanceOfZone, Test_get) {
