...
ExistsOperator::ExistsOperator(void)
{
}
...
void ExistsOperator::SetUp(void)
{
...
void ExistsOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(ExistsOperator, Test_true) {
...
TEST_F(ExistsOperator, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ExistsOperator, Test_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
