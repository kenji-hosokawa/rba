...
/**
 * Implies_Chain_Area_HighToLowToMiddle.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_Chain_Area_HighToLowToMiddle.hpp"
...
Implies_Chain_Area_HighToLowToMiddle::Implies_Chain_Area_HighToLowToMiddle(void)
{
}
...
void Implies_Chain_Area_HighToLowToMiddle::SetUp(void)
{
...
void Implies_Chain_Area_HighToLowToMiddle::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_Chain_Area_HighToLowToMiddle, Test_5) {
...
TEST_F(Implies_Chain_Area_HighToLowToMiddle, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_HighToLowToMiddle, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_HighToLowToMiddle, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_HighToLowToMiddle, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_HighToLowToMiddle, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
