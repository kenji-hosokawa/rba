...
/**
 * DisplayingContent.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "DisplayingContent.hpp"
...
DisplayingContent::DisplayingContent(void)
{
}
...
void DisplayingContent::SetUp(void)
{
...
void DisplayingContent::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(DisplayingContent, Test_get) {
...
TEST_F(DisplayingContent, Test_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
