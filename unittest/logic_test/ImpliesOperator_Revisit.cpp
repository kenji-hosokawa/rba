...
/**
 * ImpliesOperator_Revisit.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "ImpliesOperator_Revisit.hpp"
...
ImpliesOperator_Revisit::ImpliesOperator_Revisit(void)
{
}
...
void ImpliesOperator_Revisit::SetUp(void)
{
...
void ImpliesOperator_Revisit::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(ImpliesOperator_Revisit, Test_revisit) {
