...
/**
 * HA762_stateValue.hpp
 */

#ifndef HA762_STATEVALUE_HPP
#define HA762_STATEVALUE_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_stateValue.json"

namespace {

using namespace rba;

class HA762_stateValue : public ::testing::Test
{
protected:
  HA762_stateValue();
  virtual ~HA762_stateValue();
  virtual void SetUp();
