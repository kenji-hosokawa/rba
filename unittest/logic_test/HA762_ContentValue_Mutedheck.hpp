...
/**
 * HA762_ContentValue_Mutedheck.hpp
 */

#ifndef HA762_CONTENTVALUE_MUTEDHECK_HPP
#define HA762_CONTENTVALUE_MUTEDHECK_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_ContentValue_Mutedheck.json"

namespace {

using namespace rba;

class HA762_ContentValue_Mutedheck : public ::testing::Test
{
protected:
  HA762_ContentValue_Mutedheck();
  virtual ~HA762_ContentValue_Mutedheck();
  virtual void SetUp();
