...
/**
 * Implies_AND_Area_Middle_and_LowToHigh.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_AND_Area_Middle_and_LowToHigh.hpp"
...
Implies_AND_Area_Middle_and_LowToHigh::Implies_AND_Area_Middle_and_LowToHigh(void)
{
}
...
void Implies_AND_Area_Middle_and_LowToHigh::SetUp(void)
{
...
void Implies_AND_Area_Middle_and_LowToHigh::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_AND_Area_Middle_and_LowToHigh, Test_5) {
...
TEST_F(Implies_AND_Area_Middle_and_LowToHigh, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_Middle_and_LowToHigh, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_Middle_and_LowToHigh, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_Middle_and_LowToHigh, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_AND_Area_Middle_and_LowToHigh, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
