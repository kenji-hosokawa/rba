/**
 * Implies_OR_Area_High_or_LowToMiddle.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_OR_Area_High_or_LowToMiddle.hpp"
...
Implies_OR_Area_High_or_LowToMiddle::Implies_OR_Area_High_or_LowToMiddle(void)
{
}
...
void Implies_OR_Area_High_or_LowToMiddle::SetUp(void)
{
...
void Implies_OR_Area_High_or_LowToMiddle::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_OR_Area_High_or_LowToMiddle, Test_1) {
...
TEST_F(Implies_OR_Area_High_or_LowToMiddle, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_High_or_LowToMiddle, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_High_or_LowToMiddle, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_High_or_LowToMiddle, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_OR_Area_High_or_LowToMiddle, Test_ReadMe) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;


}
TEST_F(Implies_OR_Area_High_or_LowToMiddle, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
