...
/**
 * HA762_HasComeEarlierThan_SameZone.hpp
 */

#ifndef HA762_HASCOMEEARLIERTHAN_SAMEZONE_HPP
#define HA762_HASCOMEEARLIERTHAN_SAMEZONE_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_HasComeEarlierThan_SameZone.json"

namespace {

using namespace rba;

class HA762_HasComeEarlierThan_SameZone : public ::testing::Test
{
protected:
  HA762_HasComeEarlierThan_SameZone();
  virtual ~HA762_HasComeEarlierThan_SameZone();
  virtual void SetUp();
