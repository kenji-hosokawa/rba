...
/**
 * HA762_AllocatedContent_ATTcheck.hpp
 */

#ifndef HA762_ALLOCATEDCONTENT_ATTCHECK_HPP
#define HA762_ALLOCATEDCONTENT_ATTCHECK_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_AllocatedContent_ATTcheck.json"

namespace {

using namespace rba;

class HA762_AllocatedContent_ATTcheck : public ::testing::Test
{
protected:
  HA762_AllocatedContent_ATTcheck();
  virtual ~HA762_AllocatedContent_ATTcheck();
  virtual void SetUp();
