...
/**
 * HA762_GetContentsList_Set_Sound.hpp
 */

#ifndef HA762_GETCONTENTSLIST_SET_SOUND_HPP
#define HA762_GETCONTENTSLIST_SET_SOUND_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_GetContentsList_Set_Sound.json"

namespace {

using namespace rba;

class HA762_GetContentsList_Set_Sound : public ::testing::Test
{
protected:
  HA762_GetContentsList_Set_Sound();
  virtual ~HA762_GetContentsList_Set_Sound();
  virtual void SetUp();
