...
/**
 * HA762_OutputtingSound_ATTcheck.hpp
 */

#ifndef HA762_OUTPUTTINGSOUND_ATTCHECK_HPP
#define HA762_OUTPUTTINGSOUND_ATTCHECK_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_OutputtingSound_ATTcheck.json"

namespace {

using namespace rba;

class HA762_OutputtingSound_ATTcheck : public ::testing::Test
{
protected:
  HA762_OutputtingSound_ATTcheck();
  virtual ~HA762_OutputtingSound_ATTcheck();
  virtual void SetUp();
