...
/**
 * IfStatement_rearbitration_IsGreaterThanEqualOperator.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "IfStatement_rearbitration_IsGreaterThanEqualOperator.hpp"
...
IfStatement_rearbitration_IsGreaterThanEqualOperator::IfStatement_rearbitration_IsGreaterThanEqualOperator(void)
{
}
...
void IfStatement_rearbitration_IsGreaterThanEqualOperator::SetUp(void)
{
...
void IfStatement_rearbitration_IsGreaterThanEqualOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(IfStatement_rearbitration_IsGreaterThanEqualOperator, Test_AisEqualToB_BisHidden) {
...
TEST_F(IfStatement_rearbitration_IsGreaterThanEqualOperator, Test_AisGreaterThanB_BisHidden) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_rearbitration_IsGreaterThanEqualOperator, Test_AisLowerThanB_AisHidden) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_rearbitration_IsGreaterThanEqualOperator, Test_Aonly) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(IfStatement_rearbitration_IsGreaterThanEqualOperator, Test_Bonly) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
