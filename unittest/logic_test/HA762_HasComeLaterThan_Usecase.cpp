...
/**
 * HA762_HasComeLaterThan_Usecase.cpp
 */
...
#include "HA762_HasComeLaterThan_Usecase.hpp"

namespace {

using namespace rba;

HA762_HasComeLaterThan_Usecase::HA762_HasComeLaterThan_Usecase() {}
HA762_HasComeLaterThan_Usecase::~HA762_HasComeLaterThan_Usecase() {}

void HA762_HasComeLaterThan_Usecase::SetUp()
{
...
void HA762_HasComeLaterThan_Usecase::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_HasComeLaterThan_Usecase::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_HasComeLaterThan_Usecase::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_HasComeLaterThan_Usecase::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_HasComeLaterThan_Usecase::getAllocated(const std::string& msg,
...
bool HA762_HasComeLaterThan_Usecase::isCanceled(const std::string& msg,
...
bool HA762_HasComeLaterThan_Usecase::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_HasComeLaterThan_Usecase::getProperty(const std::string& msg,
...
bool HA762_HasComeLaterThan_Usecase::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_HasComeLaterThan_Usecase::isEnableContext(const std::string& msg,
...
bool HA762_HasComeLaterThan_Usecase::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_HasComeLaterThan_Usecase::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_HasComeLaterThan_Usecase, Test_01)
{
...
// 0007  #start 2
TEST_F(HA762_HasComeLaterThan_Usecase, Test_02)
{
  std::list<std::string> contexts;
...
// 0013  #start 3
TEST_F(HA762_HasComeLaterThan_Usecase, Test_03)
{
  std::list<std::string> contexts;
...
// 0020  #start 4
TEST_F(HA762_HasComeLaterThan_Usecase, Test_04)
{
  std::list<std::string> contexts;
