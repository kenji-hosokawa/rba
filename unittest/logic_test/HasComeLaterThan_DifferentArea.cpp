...
/**
 * HasComeLaterThan_DifferentArea.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "HasComeLaterThan_DifferentArea.hpp"
...
HasComeLaterThan_DifferentArea::HasComeLaterThan_DifferentArea(void)
{
}
...
void HasComeLaterThan_DifferentArea::SetUp(void)
{
...
void HasComeLaterThan_DifferentArea::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(HasComeLaterThan_DifferentArea, Test_TwoRequests1) {
...
TEST_F(HasComeLaterThan_DifferentArea, Test_TwoRequests2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeLaterThan_DifferentArea, Test_OneRequest2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(HasComeLaterThan_DifferentArea, Test_OneRequest1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
