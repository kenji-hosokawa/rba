...
/**
 * SetOfOperator_Zone.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "SetOfOperator_Zone.hpp"
...
SetOfOperator_Zone::SetOfOperator_Zone(void)
{
}
...
void SetOfOperator_Zone::SetUp(void)
{
...
void SetOfOperator_Zone::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(SetOfOperator_Zone, Test_true) {
  ...
  elems = {u8"Assert",u8"A",u8"ゾーンD",u8"コンテンツD1"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
...
TEST_F(SetOfOperator_Zone, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(SetOfOperator_Zone, Test_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
