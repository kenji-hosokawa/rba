...
/**
 * HA762_IsOutputted_ATTcheck.hpp
 */

#ifndef HA762_ISOUTPUTTED_ATTCHECK_HPP
#define HA762_ISOUTPUTTED_ATTCHECK_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_IsOutputted_ATTcheck.json"

namespace {

using namespace rba;

class HA762_IsOutputted_ATTcheck : public ::testing::Test
{
protected:
  HA762_IsOutputted_ATTcheck();
  virtual ~HA762_IsOutputted_ATTcheck();
  virtual void SetUp();
