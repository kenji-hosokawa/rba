...
/**
 * AllInstanceOfSoundContent.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "AllInstanceOfSoundContent.hpp"
...
AllInstanceOfSoundContent::AllInstanceOfSoundContent(void)
{
}
...
void AllInstanceOfSoundContent::SetUp(void)
{
...
void AllInstanceOfSoundContent::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(AllInstanceOfSoundContent, Test_get) {
  ...
  elems = {u8"Assert",u8"A",u8"ゾーンB",u8"コンテンツB2"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
