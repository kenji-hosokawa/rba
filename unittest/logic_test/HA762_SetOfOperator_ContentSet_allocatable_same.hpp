...
/**
 * HA762_SetOfOperator_ContentSet_allocatable_same.hpp
 */

#ifndef HA762_SETOFOPERATOR_CONTENTSET_ALLOCATABLE_SAME_HPP
#define HA762_SETOFOPERATOR_CONTENTSET_ALLOCATABLE_SAME_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_SetOfOperator_ContentSet_allocatable_same.json"

namespace {

using namespace rba;

class HA762_SetOfOperator_ContentSet_allocatable_same : public ::testing::Test
{
protected:
  HA762_SetOfOperator_ContentSet_allocatable_same();
  virtual ~HA762_SetOfOperator_ContentSet_allocatable_same();
  virtual void SetUp();
