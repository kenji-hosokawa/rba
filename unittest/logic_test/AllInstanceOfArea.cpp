...
/**
 * AllInstanceOfArea.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "AllInstanceOfArea.hpp"
...
AllInstanceOfArea::AllInstanceOfArea(void)
{
}
...
void AllInstanceOfArea::SetUp(void)
{
...
void AllInstanceOfArea::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(AllInstanceOfArea, Test_get) {
