...
/**
 * HA762_HasComeLaterThan_Usecase2_Sound.hpp
 */

#ifndef HA762_HASCOMELATERTHAN_USECASE2_SOUND_HPP
#define HA762_HASCOMELATERTHAN_USECASE2_SOUND_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_HasComeLaterThan_Usecase2_Sound.json"

namespace {

using namespace rba;

class HA762_HasComeLaterThan_Usecase2_Sound : public ::testing::Test
{
protected:
  HA762_HasComeLaterThan_Usecase2_Sound();
  virtual ~HA762_HasComeLaterThan_Usecase2_Sound();
  virtual void SetUp();
