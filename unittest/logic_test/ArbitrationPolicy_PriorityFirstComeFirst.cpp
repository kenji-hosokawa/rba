...
/**
 * ArbitrationPolicy_PriorityFirstComeFirst.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "ArbitrationPolicy_PriorityFirstComeFirst.hpp"
...
ArbitrationPolicy_PriorityFirstComeFirst::ArbitrationPolicy_PriorityFirstComeFirst(void)
{
}
...
void ArbitrationPolicy_PriorityFirstComeFirst::SetUp(void)
{
...
void ArbitrationPolicy_PriorityFirstComeFirst::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(ArbitrationPolicy_PriorityFirstComeFirst, Test_basic) {
