...
/**
 * Implies_MultiArea_Area_HighToMiddle.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_MultiArea_Area_HighToMiddle.hpp"
...
Implies_MultiArea_Area_HighToMiddle::Implies_MultiArea_Area_HighToMiddle(void)
{
}
...
void Implies_MultiArea_Area_HighToMiddle::SetUp(void)
{
...
void Implies_MultiArea_Area_HighToMiddle::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_MultiArea_Area_HighToMiddle, Test_4) {
...
TEST_F(Implies_MultiArea_Area_HighToMiddle, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MultiArea_Area_HighToMiddle, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_MultiArea_Area_HighToMiddle, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
