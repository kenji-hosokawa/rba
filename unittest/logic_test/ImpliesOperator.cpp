...
ImpliesOperator::ImpliesOperator(void)
{
}
...
void ImpliesOperator::SetUp(void)
{
...
void ImpliesOperator::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(ImpliesOperator, Test_true) {
...
TEST_F(ImpliesOperator, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(ImpliesOperator, Test_exception) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
