...
/**
 * GetContentsList_Set.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "GetContentsList_Set.hpp"
...
GetContentsList_Set::GetContentsList_Set(void)
{
}
...
void GetContentsList_Set::SetUp(void)
{
...
void GetContentsList_Set::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(GetContentsList_Set, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;

  elems = {u8"C",u8"ON",u8"コンテントX",u8"NORMAL"};
  {
  ...
  elems = {u8"Assert",u8"A",u8"エリアA",u8"コンテントX"};
  {
    std::string kind = elems[1];
  ...
  elems = {u8"Assert",u8"A",u8"エリアB",u8"コンテントX"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"エリアC",u8"コンテントX"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"エリアD",u8"コンテントX"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"エリアE",u8"コンテントX"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
...
TEST_F(GetContentsList_Set, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
  ...
  elems = {u8"C",u8"ON",u8"コンテントY",u8"NORMAL"};
  {
    std::string kind = elems[1];
    std::string cont = elems[2];
    std::string state = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"エリアD",u8"コンテントY"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"エリアE",u8"コンテントY"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
  ...
  elems = {u8"Assert",u8"A",u8"エリアF",u8"コンテントY"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
