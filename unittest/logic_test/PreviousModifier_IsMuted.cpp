...
#include "PreviousModifier_IsMuted.hpp"
...
PreviousModifier_IsMuted::PreviousModifier_IsMuted(void)
{
}
...
void PreviousModifier_IsMuted::SetUp(void)
{
...
void PreviousModifier_IsMuted::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(PreviousModifier_IsMuted, Test_true) {
...
TEST_F(PreviousModifier_IsMuted, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
  std::list<std::string> contextlist;
