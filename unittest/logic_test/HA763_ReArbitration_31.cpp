...
#include "HA763_ReArbitration_31.hpp"

namespace {

using namespace rba;

HA763_ReArbitration_31::HA763_ReArbitration_31() {}
HA763_ReArbitration_31::~HA763_ReArbitration_31() {}

void HA763_ReArbitration_31::SetUp()
{
...
void HA763_ReArbitration_31::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA763_ReArbitration_31::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA763_ReArbitration_31::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA763_ReArbitration_31::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA763_ReArbitration_31::getAllocated(const std::string& msg,
...
bool HA763_ReArbitration_31::isCanceled(const std::string& msg,
...
bool HA763_ReArbitration_31::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA763_ReArbitration_31::getProperty(const std::string& msg,
...
bool HA763_ReArbitration_31::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA763_ReArbitration_31::isEnableContext(const std::string& msg,
...
bool HA763_ReArbitration_31::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA763_ReArbitration_31::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA763_ReArbitration_31, Test_01)
{
