...
/**
 * HA762_SetOfOperator_ZoneSet_nest.hpp
 */

#ifndef HA762_SETOFOPERATOR_ZONESET_NEST_HPP
#define HA762_SETOFOPERATOR_ZONESET_NEST_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_SetOfOperator_ZoneSet_nest.json"

namespace {

using namespace rba;

class HA762_SetOfOperator_ZoneSet_nest : public ::testing::Test
{
protected:
  HA762_SetOfOperator_ZoneSet_nest();
  virtual ~HA762_SetOfOperator_ZoneSet_nest();
  virtual void SetUp();
