...
/**
 * HA762_IsSounding_Mutedcheck.hpp
 */

#ifndef HA762_ISSOUNDING_MUTEDCHECK_HPP
#define HA762_ISSOUNDING_MUTEDCHECK_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_IsSounding_Mutedcheck.json"

namespace {

using namespace rba;

class HA762_IsSounding_Mutedcheck : public ::testing::Test
{
protected:
  HA762_IsSounding_Mutedcheck();
  virtual ~HA762_IsSounding_Mutedcheck();
  virtual void SetUp();
