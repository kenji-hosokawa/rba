...
/**
 * HA762_PreviousModifier_stateValue.cpp
 */
...
#include "HA762_PreviousModifier_stateValue.hpp"

namespace {

using namespace rba;

HA762_PreviousModifier_stateValue::HA762_PreviousModifier_stateValue() {}
HA762_PreviousModifier_stateValue::~HA762_PreviousModifier_stateValue() {}

void HA762_PreviousModifier_stateValue::SetUp()
{
...
void HA762_PreviousModifier_stateValue::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_PreviousModifier_stateValue::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_PreviousModifier_stateValue::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_PreviousModifier_stateValue::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_PreviousModifier_stateValue::getAllocated(const std::string& msg,
...
bool HA762_PreviousModifier_stateValue::isCanceled(const std::string& msg,
...
bool HA762_PreviousModifier_stateValue::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_PreviousModifier_stateValue::getProperty(const std::string& msg,
...
bool HA762_PreviousModifier_stateValue::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_PreviousModifier_stateValue::isEnableContext(const std::string& msg,
...
bool HA762_PreviousModifier_stateValue::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_PreviousModifier_stateValue::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_PreviousModifier_stateValue, Test_01)
{
