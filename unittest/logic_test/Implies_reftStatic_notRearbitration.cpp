...
/**
 * Implies_reftStatic_notRearbitration.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_reftStatic_notRearbitration.hpp"
...
Implies_reftStatic_notRearbitration::Implies_reftStatic_notRearbitration(void)
{
}
...
void Implies_reftStatic_notRearbitration::SetUp(void)
{
...
void Implies_reftStatic_notRearbitration::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_reftStatic_notRearbitration, Test_1) {
  ...
  elems = {u8"Assert",u8"A",u8"B",u8"A1"};
  {
    std::string kind = elems[1];
    std::string target = elems[2];
    std::string expect = elems[3];
...
TEST_F(Implies_reftStatic_notRearbitration, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
