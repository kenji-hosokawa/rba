...
/**
 * View_reArbitration_Sound.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "View_reArbitration_Sound.hpp"
...
View_reArbitration_Sound::View_reArbitration_Sound(void)
{
}
...
void View_reArbitration_Sound::SetUp(void)
{
...
void View_reArbitration_Sound::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(View_reArbitration_Sound, Test_1) {
