...
/**
 * Implies_Content_LowToHigh_Area_.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_Content_LowToHigh_Area_.hpp"
...
Implies_Content_LowToHigh_Area_::Implies_Content_LowToHigh_Area_(void)
{
}
...
void Implies_Content_LowToHigh_Area_::SetUp(void)
{
...
void Implies_Content_LowToHigh_Area_::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_15) {
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_14) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_16) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_13) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_12) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_10) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_11) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_9) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_8) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_5) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_7) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Content_LowToHigh_Area_, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
