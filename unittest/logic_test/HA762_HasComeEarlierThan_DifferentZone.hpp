...
/**
 * HA762_HasComeEarlierThan_DifferentZone.hpp
 */

#ifndef HA762_HASCOMEEARLIERTHAN_DIFFERENTZONE_HPP
#define HA762_HASCOMEEARLIERTHAN_DIFFERENTZONE_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_HasComeEarlierThan_DifferentZone.json"

namespace {

using namespace rba;

class HA762_HasComeEarlierThan_DifferentZone : public ::testing::Test
{
protected:
  HA762_HasComeEarlierThan_DifferentZone();
  virtual ~HA762_HasComeEarlierThan_DifferentZone();
  virtual void SetUp();
