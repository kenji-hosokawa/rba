...
/**
 * SetOfOperator_ZoneSet_Zone.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "SetOfOperator_ZoneSet_Zone.hpp"
...
SetOfOperator_ZoneSet_Zone::SetOfOperator_ZoneSet_Zone(void)
{
}
...
void SetOfOperator_ZoneSet_Zone::SetUp(void)
{
...
void SetOfOperator_ZoneSet_Zone::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(SetOfOperator_ZoneSet_Zone, Test_test) {
