...
/**
 * Implies_Chain_Area_LowToHighToMiddle.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "Implies_Chain_Area_LowToHighToMiddle.hpp"
...
Implies_Chain_Area_LowToHighToMiddle::Implies_Chain_Area_LowToHighToMiddle(void)
{
}
...
void Implies_Chain_Area_LowToHighToMiddle::SetUp(void)
{
...
void Implies_Chain_Area_LowToHighToMiddle::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(Implies_Chain_Area_LowToHighToMiddle, Test_5) {
...
TEST_F(Implies_Chain_Area_LowToHighToMiddle, Test_4) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_LowToHighToMiddle, Test_6) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_LowToHighToMiddle, Test_3) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_LowToHighToMiddle, Test_2) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(Implies_Chain_Area_LowToHighToMiddle, Test_1) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
