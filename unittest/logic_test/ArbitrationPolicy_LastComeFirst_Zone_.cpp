...
/**
 * ArbitrationPolicy_LastComeFirst_Zone_.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "ArbitrationPolicy_LastComeFirst_Zone_.hpp"
...
ArbitrationPolicy_LastComeFirst_Zone_::ArbitrationPolicy_LastComeFirst_Zone_(void)
{
}
...
void ArbitrationPolicy_LastComeFirst_Zone_::SetUp(void)
{
...
void ArbitrationPolicy_LastComeFirst_Zone_::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(ArbitrationPolicy_LastComeFirst_Zone_, Test_basic) {
  ...
  elems = {u8"C",u8"OFF",u8"C3",u8"CS_N"};
  {
    std::string kind = elems[1];
    std::string cont = elems[2];
    std::string state = elems[3];
