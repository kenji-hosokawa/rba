...
/**
 * HA762_IfStatement_Boolean_exception.hpp
 */

#ifndef HA762_IFSTATEMENT_BOOLEAN_EXCEPTION_HPP
#define HA762_IFSTATEMENT_BOOLEAN_EXCEPTION_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_IfStatement_Boolean_exception.json"

namespace {

using namespace rba;

class HA762_IfStatement_Boolean_exception : public ::testing::Test
{
protected:
  HA762_IfStatement_Boolean_exception();
  virtual ~HA762_IfStatement_Boolean_exception();
  virtual void SetUp();
