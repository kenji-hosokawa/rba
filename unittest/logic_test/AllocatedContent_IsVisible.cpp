...
/**
 * AllocatedContent_IsVisible.cpp
 */

#include <vector>
#include <string>
#include "RBAJsonParser.hpp"
#include "AllocatedContent_IsVisible.hpp"
...
AllocatedContent_IsVisible::AllocatedContent_IsVisible(void)
{
}
...
void AllocatedContent_IsVisible::SetUp(void)
{
...
void AllocatedContent_IsVisible::TearDown(void)
{
  delete arb;
  delete model;
  arb = nullptr;
...
TEST_F(AllocatedContent_IsVisible, Test_exception) {
...
TEST_F(AllocatedContent_IsVisible, Test_false) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
...
TEST_F(AllocatedContent_IsVisible, Test_true) {
  std::vector<std::string> elems;
  std::unique_ptr<RBAResult> result;
