...
#include "HA762_AndOperator.hpp"

namespace {

using namespace rba;

HA762_AndOperator::HA762_AndOperator() {}
HA762_AndOperator::~HA762_AndOperator() {}

void HA762_AndOperator::SetUp()
{
...
void HA762_AndOperator::TearDown()
{
  delete arb_;
  delete model_;
  arb_ = nullptr;
...
bool HA762_AndOperator::isSuccess(const std::string& msg)
{
  return RBAResultStatusType::SUCCESS == result_->getStatusType();
}

bool HA762_AndOperator::isSatisfiedConstraints(const std::string& msg)
{
  return result_->satisfiesConstraints();
}

bool HA762_AndOperator::isTrue(const std::string& msg, bool res)
{
  return res;
}

std::string HA762_AndOperator::getAllocated(const std::string& msg,
...
bool HA762_AndOperator::isCanceled(const std::string& msg,
...
bool HA762_AndOperator::isActive(const std::string& msg, const std::string& sceneName)
{
...
int32_t HA762_AndOperator::getProperty(const std::string& msg,
...
bool HA762_AndOperator::isEnableAllocatable(const std::string& msg,
                                const std::string& allocName)
{
  const RBAArea* area = model_->findArea(allocName);
  if(area) {
...
bool HA762_AndOperator::isEnableContext(const std::string& msg,
...
bool HA762_AndOperator::isEnableScene(const std::string& msg,
                          const std::string& sceneName)
{
  const RBAScene* scene = model_->findScene(sceneName);
...
bool HA762_AndOperator::isAttenuated(const std::string& msg,
...
// 0001  #start 1
TEST_F(HA762_AndOperator, Test_01)
{
...
// 0014  #start 2
TEST_F(HA762_AndOperator, Test_02)
{
  std::list<std::string> contexts;
  ...
  // 0025  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=25", u8"E"));
}

// 0027  #start 3
TEST_F(HA762_AndOperator, Test_03)
{
  std::list<std::string> contexts;
  ...
  // 0038  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=38", u8"E"));
}

// 0040  #start 4
TEST_F(HA762_AndOperator, Test_04)
{
  std::list<std::string> contexts;
  ...
  // 0050  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=50", u8"D"));
  // 0051  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=51", u8"E"));
}

// 0053  #start 5
TEST_F(HA762_AndOperator, Test_05)
{
  std::list<std::string> contexts;
  ...
  // 0063  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=63", u8"D"));
  // 0064  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=64", u8"E"));
}

// 0066  #start 6
TEST_F(HA762_AndOperator, Test_06)
{
  std::list<std::string> contexts;
  ...
  // 0076  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=76", u8"D"));
  // 0077  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=77", u8"E"));
}

// 0079  #start 7
TEST_F(HA762_AndOperator, Test_07)
{
  std::list<std::string> contexts;
  ...
  // 0089  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=89", u8"D"));
  // 0090  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=90", u8"E"));
}

// 0092  #start 8
TEST_F(HA762_AndOperator, Test_08)
{
  std::list<std::string> contexts;
...
// 0105  #start 9
TEST_F(HA762_AndOperator, Test_09)
{
  std::list<std::string> contexts;
  ...
  // 0115  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=115", u8"E"));
}

// 0117  #start 10
TEST_F(HA762_AndOperator, Test_10)
{
  std::list<std::string> contexts;
  ...
  // 0126  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=126", u8"D"));
  // 0127  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=127", u8"E"));
}

// 0129  #start 11
TEST_F(HA762_AndOperator, Test_11)
{
  std::list<std::string> contexts;
  ...
  // 0138  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=138", u8"D"));
  // 0139  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=139", u8"E"));
}

// 0141  #start 12
TEST_F(HA762_AndOperator, Test_12)
{
  std::list<std::string> contexts;
  ...
  // 0149  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=149", u8"D"));
  // 0150  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=150", u8"E"));
}

// 0152  #start 13
TEST_F(HA762_AndOperator, Test_13)
{
  std::list<std::string> contexts;
  ...
  // 0160  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=160", u8"D"));
  // 0161  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=161", u8"E"));
}

// 0163  #start 14
TEST_F(HA762_AndOperator, Test_14)
{
  std::list<std::string> contexts;
  ...
  // 0171  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=171", u8"D"));
  // 0172  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=172", u8"E"));
}

// 0174  #start 15
TEST_F(HA762_AndOperator, Test_15)
{
  std::list<std::string> contexts;
...
// 0186  #start 16
TEST_F(HA762_AndOperator, Test_16)
{
  std::list<std::string> contexts;
...
// 0198  #start 17
TEST_F(HA762_AndOperator, Test_17)
{
  std::list<std::string> contexts;
...
// 0210  #start 18
TEST_F(HA762_AndOperator, Test_18)
{
  std::list<std::string> contexts;
...
// 0221  #start 19
TEST_F(HA762_AndOperator, Test_19)
{
  std::list<std::string> contexts;
...
// 0232  #start 20
TEST_F(HA762_AndOperator, Test_20)
{
  std::list<std::string> contexts;
...
// 0243  #start 21
TEST_F(HA762_AndOperator, Test_21)
{
  std::list<std::string> contexts;
  ...
  // 0252  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=252", u8"D"));
  // 0253  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=253", u8"E"));
}

// 0255  #start 22
TEST_F(HA762_AndOperator, Test_22)
{
  std::list<std::string> contexts;
  ...
  // 0264  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=264", u8"D"));
  // 0265  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=265", u8"E"));
}

// 0267  #start 23
TEST_F(HA762_AndOperator, Test_23)
{
  std::list<std::string> contexts;
  ...
  // 0276  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=276", u8"D"));
  // 0277  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=277", u8"E"));
}

// 0279  #start 24
TEST_F(HA762_AndOperator, Test_24)
{
  std::list<std::string> contexts;
  ...
  // 0288  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=288", u8"D"));
  // 0289  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=289", u8"E"));
}

// 0291  #start 25
TEST_F(HA762_AndOperator, Test_25)
{
  std::list<std::string> contexts;
  ...
  // 0300  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=300", u8"D"));
  // 0301  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=301", u8"E"));
}

// 0303  #start 26
TEST_F(HA762_AndOperator, Test_26)
{
  std::list<std::string> contexts;
  ...
  // 0312  Assert,A,D,d1
  EXPECT_EQ(u8"d1",getAllocated("line=312", u8"D"));
  // 0313  Assert,A,E,
  EXPECT_EQ(u8"",getAllocated("line=313", u8"E"));
}

// 0315  #start 27
TEST_F(HA762_AndOperator, Test_27)
{
  std::list<std::string> contexts;
