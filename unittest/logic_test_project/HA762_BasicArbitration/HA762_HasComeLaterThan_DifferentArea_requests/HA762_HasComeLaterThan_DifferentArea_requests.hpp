...
/**
 * HA762_HasComeLaterThan_DifferentArea_requests.hpp
 */

#ifndef HA762_HASCOMELATERTHAN_DIFFERENTAREA_REQUESTS_HPP
#define HA762_HASCOMELATERTHAN_DIFFERENTAREA_REQUESTS_HPP

#include <string>
#include "gtest/gtest.h"
#include "RBAArbitrator.hpp"

#define JSONFILE  "HA762_HasComeLaterThan_DifferentArea_requests.json"

namespace {

using namespace rba;

class HA762_HasComeLaterThan_DifferentArea_requests : public ::testing::Test
{
protected:
  HA762_HasComeLaterThan_DifferentArea_requests();
  virtual ~HA762_HasComeLaterThan_DifferentArea_requests();
  virtual void SetUp();
